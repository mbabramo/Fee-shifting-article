...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (3.3071,9.5774);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5774) rectangle (2.7881,10.107);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.107) rectangle (2.269,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.81) rectangle (1.75,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.1905,9.3386);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.3386) rectangle (6.6714,10.091);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.091) rectangle (6.1524,12.304);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.304) rectangle (5.8929,13.006);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.006) rectangle (5.6333,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.0921) rectangle (11.333,9.8447);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8447) rectangle (11.333,10.375);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.375) rectangle (11.333,12.587);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.587) rectangle (11.333,13.072);
...
\node[black, centered, rotate=90] at (13.72, 11.557) {Settles};
