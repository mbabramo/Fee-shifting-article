...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1224) rectangle (2.1692,8.2905);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.2905) rectangle (1.75,9.0921);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (4.6846,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (4.4051,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (4.1256,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (3.8462,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (3.5667,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (3.2872,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (3.0077,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (2.7282,9.5154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5154) rectangle (2.4487,9.5154);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.5154) rectangle (1.75,11.432);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.432) rectangle (2.1692,11.432);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1224) rectangle (8.4282,4.924);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.924) rectangle (5.6333,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (8.5679,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (8.2885,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (8.009,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.7295,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.45,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.1705,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.1705,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (6.891,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (6.6115,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (6.3321,11.009);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.009) rectangle (5.7731,11.009);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.009) rectangle (5.6333,11.432);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.432) rectangle (8.8474,11.432);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.432) rectangle (6.0526,11.432);
