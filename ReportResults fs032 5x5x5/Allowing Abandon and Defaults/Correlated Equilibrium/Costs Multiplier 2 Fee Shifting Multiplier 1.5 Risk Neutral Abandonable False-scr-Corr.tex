...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (3.494,9.5774);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5774) rectangle (2.9127,10.107);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.107) rectangle (2.3313,10.81);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.3773,9.3386);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.3386) rectangle (6.796,10.091);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.091) rectangle (6.2147,12.304);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.304) rectangle (5.924,13.006);
