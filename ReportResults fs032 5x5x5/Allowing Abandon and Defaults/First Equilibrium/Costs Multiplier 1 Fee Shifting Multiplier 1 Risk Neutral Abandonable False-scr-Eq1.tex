...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.359) rectangle (4.2479,10.874);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.874) rectangle (1.75,12.365);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.359) rectangle (6.0875,11.85);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.85) rectangle (5.6333,12.365);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.359) rectangle (11.333,11.85);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.85) rectangle (11.333,12.365);
...
\node[black, centered, rotate=90] at (13.72, 11.362) {Settles};
