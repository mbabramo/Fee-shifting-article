...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.1307,1.9825);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.9825) rectangle (2.9127,5.9655);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.9655) rectangle (2.6947,8.1164);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.1164) rectangle (1.75,14.483);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.014,1.9825);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9825) rectangle (6.796,5.9654);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.9654) rectangle (6.578,8.1166);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.1166) rectangle (5.6333,14.483);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,5.7329);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.7329) rectangle (11.333,9.7159);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.7159) rectangle (11.333,12.1);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.1) rectangle (11.333,14.483);
...
\node[black, centered, rotate=90] at (13.72, 8.1165) {Settles};
