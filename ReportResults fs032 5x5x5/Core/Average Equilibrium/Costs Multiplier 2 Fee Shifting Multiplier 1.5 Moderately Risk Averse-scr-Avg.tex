...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (3.2033,9.0921);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (3.058,9.0921);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (2.9127,10.507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.507) rectangle (2.7673,10.507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.507) rectangle (2.622,10.507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.507) rectangle (2.4767,10.507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.507) rectangle (2.3313,10.507);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.3773,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.232,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (7.0867,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (6.9413,9.0921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (6.796,11.317);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.317) rectangle (6.6507,11.317);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.317) rectangle (6.5053,11.317);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.317) rectangle (5.924,11.317);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.317) rectangle (5.7787,11.317);
