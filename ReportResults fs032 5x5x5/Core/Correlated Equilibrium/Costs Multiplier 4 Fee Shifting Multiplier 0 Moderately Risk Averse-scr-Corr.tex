...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.4015,2.8119);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.8119) rectangle (1.75,7.2053);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.2053) rectangle (2.7409,12.218);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.218) rectangle (1.75,13.573);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.573) rectangle (4.2273,13.626);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.626) rectangle (4.0621,13.718);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.491) rectangle (3.7318,14.497);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.2053) rectangle (7.2848,8.5605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.5605) rectangle (5.6333,13.573);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.573) rectangle (7.1197,13.653);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.653) rectangle (6.9545,13.857);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.857) rectangle (6.7894,14.109);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.483) rectangle (7.6152,14.488);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.488) rectangle (5.9636,14.491);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.2053) rectangle (10.425,8.5605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.5605) rectangle (10.425,13.573);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.573) rectangle (11.333,14.109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.109) rectangle (11.333,14.335);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.335) rectangle (11.333,14.399);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.399) rectangle (11.333,14.428);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.428) rectangle (11.333,14.445);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.445) rectangle (11.333,14.483);
...
\node[black, centered, rotate=90] at (13.72, 4.4776) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 10.389) {D Doesn't Answer};
