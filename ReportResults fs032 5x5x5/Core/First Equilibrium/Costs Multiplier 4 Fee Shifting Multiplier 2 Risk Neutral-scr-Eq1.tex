...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.5399,3.0734);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.0734) rectangle (1.75,7.9544);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.9544) rectangle (2.2239,12.664);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.664) rectangle (1.75,13.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.63) rectangle (2.9743,13.75);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.75) rectangle (1.75,14.045);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.045) rectangle (3.0138,14.19);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.19) rectangle (1.75,14.377);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.377) rectangle (2.2239,14.401);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.401) rectangle (1.75,14.416);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.416) rectangle (5.3833,14.43);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.9544) rectangle (6.4232,8.921);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.921) rectangle (5.6333,13.63);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.63) rectangle (6.1467,13.925);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.925) rectangle (5.6333,14.045);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.045) rectangle (6.1072,14.233);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.233) rectangle (5.6333,14.377);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.377) rectangle (6.8971,14.392);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.392) rectangle (6.1072,14.416);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.446) rectangle (9.2667,14.46);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.46) rectangle (8.4768,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.9544) rectangle (10.425,8.921);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.921) rectangle (10.425,13.63);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.63) rectangle (11.333,13.925);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.925) rectangle (11.333,14.045);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.045) rectangle (11.333,14.233);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.233) rectangle (11.333,14.377);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.377) rectangle (11.333,14.392);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.392) rectangle (11.333,14.416);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.416) rectangle (13.15,14.431);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.431) rectangle (13.15,14.446);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.446) rectangle (13.15,14.46);
...
\node[black, centered, rotate=90] at (13.72, 4.8522) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 10.792) {D Doesn't Answer};
