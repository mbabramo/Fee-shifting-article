...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.006) rectangle (4.0447,12.24);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.24) rectangle (1.75,12.744);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.744) rectangle (4.236,12.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.943) rectangle (1.75,13.377);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.006) rectangle (6.3982,12.511);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.511) rectangle (5.6333,12.744);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.744) rectangle (6.207,13.178);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.006) rectangle (11.333,12.511);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.511) rectangle (11.333,12.744);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.744) rectangle (11.333,13.178);
