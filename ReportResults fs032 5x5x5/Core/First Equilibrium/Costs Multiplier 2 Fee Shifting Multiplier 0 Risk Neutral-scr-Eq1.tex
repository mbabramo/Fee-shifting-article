...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.407) rectangle (4.5885,11.784);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.784) rectangle (1.75,13.11);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.407) rectangle (6.4281,12.733);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.733) rectangle (5.6333,13.11);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.407) rectangle (11.333,12.733);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.733) rectangle (11.333,13.11);
...
\node[black, centered, rotate=90] at (13.72, 12.258) {Settles};
