...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.489) rectangle (1.8134,13.437);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.437) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.7476,1.939);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.939) rectangle (7.4189,1.9457);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9457) rectangle (7.0867,1.9462);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9462) rectangle (6.7545,1.9467);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9467) rectangle (6.4223,1.9471);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9471) rectangle (6.0901,4.0618);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.0618) rectangle (5.6333,5.9689);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.9689) rectangle (9.0798,6.0209);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.0209) rectangle (5.7579,6.4775);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.4775) rectangle (5.7579,9.4255);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.552) rectangle (5.9448,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,1.939);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.939) rectangle (11.333,3.5965);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.5965) rectangle (11.333,5.7112);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.7112) rectangle (11.333,5.9526);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.9526) rectangle (11.333,5.9531);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.9531) rectangle (11.333,5.9535);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.9535) rectangle (11.333,5.9612);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.9612) rectangle (11.333,5.9689);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.9689) rectangle (11.333,6.0209);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.0209) rectangle (11.333,6.4775);
