...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1222) rectangle (4.1931,4.7575);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.7575) rectangle (3.1908,4.9239);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.9239) rectangle (2.1885,6.8406);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1222) rectangle (8.2644,4.5455);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.5455) rectangle (7.2621,4.7471);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.7471) rectangle (6.2598,8.7138);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.7138) rectangle (5.7586,10.63);
