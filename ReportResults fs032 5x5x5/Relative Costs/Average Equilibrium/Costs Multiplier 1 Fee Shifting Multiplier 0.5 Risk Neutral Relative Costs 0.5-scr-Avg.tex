...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (1.9596,3.8726);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.8726) rectangle (1.75,4.1222);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1222) rectangle (4.475,4.7575);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.7575) rectangle (3.3571,4.9239);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.9239) rectangle (2.2391,6.8406);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.966) rectangle (1.9596,14.014);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.014) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.2758,1.9996);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.9996) rectangle (5.6333,4.1222);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1222) rectangle (8.4079,4.5455);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.5455) rectangle (7.3509,4.7471);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.7471) rectangle (6.2939,8.7138);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.7138) rectangle (5.7655,10.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.63) rectangle (5.6333,11.432);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.432) rectangle (6.0297,12.48);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1222) rectangle (11.333,4.3238);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.3238) rectangle (11.333,4.4902);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.4902) rectangle (11.333,8.8802);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.8802) rectangle (11.333,11.432);
...
\node[black, centered, rotate=90] at (13.72, 7.7772) {Settles};
