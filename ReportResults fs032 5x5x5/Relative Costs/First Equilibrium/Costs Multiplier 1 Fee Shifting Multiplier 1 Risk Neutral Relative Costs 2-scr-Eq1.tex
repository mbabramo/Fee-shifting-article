...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.6623,2.1914);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.1914) rectangle (1.75,4.9538);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.9538) rectangle (2.3237,9.3674);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.3674) rectangle (1.75,10.346);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.346) rectangle (4.0447,10.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.485) rectangle (3.2798,10.509);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.509) rectangle (2.5149,10.839);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.839) rectangle (1.75,11.832);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.832) rectangle (4.236,11.905);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.905) rectangle (1.75,12.321);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.321) rectangle (2.3237,12.79);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.9538) rectangle (7.5456,5.9328);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.9328) rectangle (5.6333,10.346);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.346) rectangle (7.6412,10.556);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.556) rectangle (6.8763,10.609);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.609) rectangle (6.1114,11.34);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.34) rectangle (5.7289,11.67);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.67) rectangle (5.6333,11.832);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.832) rectangle (5.9202,12.248);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.248) rectangle (5.6333,12.321);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.321) rectangle (7.8325,12.603);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.603) rectangle (5.9202,13.072);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.236) rectangle (7.3544,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.9538) rectangle (10.728,5.9328);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.9328) rectangle (10.728,10.346);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.346) rectangle (11.333,10.399);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.399) rectangle (11.333,10.424);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.424) rectangle (11.333,11.364);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.364) rectangle (11.333,11.832);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.832) rectangle (11.333,12.248);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.248) rectangle (11.333,12.321);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.321) rectangle (11.333,12.603);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.603) rectangle (11.333,13.072);
...
\node[black, centered, rotate=90] at (13.72, 3.3519) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 7.6501) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 11.089) {Settles};
