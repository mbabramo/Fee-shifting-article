...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1224) rectangle (4.381,4.3612);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.3612) rectangle (3.8799,4.5457);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.5457) rectangle (3.3787,5.0926);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.0926) rectangle (2.8776,5.7955);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.7955) rectangle (2.3764,9.0591);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1224) rectangle (8.0764,4.5111);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.5111) rectangle (7.5753,4.7576);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.7576) rectangle (7.0741,5.2694);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.2694) rectangle (6.573,5.6766);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6766) rectangle (6.0718,7.1861);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1224) rectangle (11.333,4.5297);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.5297) rectangle (11.333,4.7141);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.7141) rectangle (11.333,7.3706);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.3706) rectangle (11.333,12.123);
...
\node[black, centered, rotate=90] at (13.72, 8.1226) {Settles};
