...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.347) rectangle (3.8768,10.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.485) rectangle (3.1679,10.509);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.509) rectangle (2.4589,10.839);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.839) rectangle (1.75,11.833);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.833) rectangle (4.0541,11.905);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.905) rectangle (1.75,12.321);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.321) rectangle (2.2817,12.79);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.347) rectangle (7.3674,10.557);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.557) rectangle (6.7068,10.61);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.61) rectangle (6.0462,11.34);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.34) rectangle (5.7159,11.67);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.67) rectangle (5.6333,11.833);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.833) rectangle (5.8811,12.248);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.248) rectangle (5.6333,12.321);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.321) rectangle (7.5326,12.603);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.603) rectangle (5.8811,13.072);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.347) rectangle (11.333,10.4);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.4) rectangle (11.333,10.424);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.424) rectangle (11.333,11.364);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.364) rectangle (11.333,11.833);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.833) rectangle (11.333,12.248);
...
\node[black, centered, rotate=90] at (13.72, 11.09) {Settles};
