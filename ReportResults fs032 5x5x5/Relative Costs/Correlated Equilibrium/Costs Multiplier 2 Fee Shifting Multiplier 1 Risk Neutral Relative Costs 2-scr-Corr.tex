...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.73) rectangle (3.6964,12.935);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.935) rectangle (1.75,13.409);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.409) rectangle (3.8262,13.494);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.494) rectangle (1.75,13.711);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.711) rectangle (2.5286,13.942);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.942) rectangle (1.75,14.039);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.73) rectangle (6.1524,13.204);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.204) rectangle (5.6333,13.409);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.409) rectangle (6.0226,13.626);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.626) rectangle (5.6333,13.711);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.711) rectangle (7.3202,13.809);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.809) rectangle (6.0226,14.039);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.73) rectangle (11.333,13.204);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.204) rectangle (11.333,13.409);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.409) rectangle (11.333,13.626);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.626) rectangle (11.333,13.711);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.711) rectangle (11.333,13.809);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.809) rectangle (11.333,14.039);
