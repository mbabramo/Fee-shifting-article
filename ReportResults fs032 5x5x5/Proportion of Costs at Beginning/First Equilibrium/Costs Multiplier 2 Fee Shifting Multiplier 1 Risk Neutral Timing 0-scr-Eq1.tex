...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2364,2.0688);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0688) rectangle (2.5758,2.0862);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0862) rectangle (1.9152,4.1914);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,4.1914) rectangle (1.75,6.84);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.84) rectangle (3.4015,7.9852);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.1197,1.987);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.987) rectangle (6.4591,1.9996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9996) rectangle (5.7985,4.3986);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.734) rectangle (7.2848,11.298);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.945) rectangle (7.6152,14.5);
...
\node[black, centered, rotate=90] at (13.72, 4.295) {Settles};
\node[black, centered, rotate=90] at (13.72, 8.7868) {P Abandons};
\node[black, centered, rotate=90] at (13.72, 12.042) {D Defaults};
