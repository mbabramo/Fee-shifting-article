...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.7937,2.0328);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0328) rectangle (2.8854,2.0498);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0498) rectangle (1.9771,4.3228);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,4.3228) rectangle (1.75,6.8958);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8958) rectangle (4.0208,7.532);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.418) rectangle (3.1125,14.158);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.158) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.6771,2.0328);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0328) rectangle (6.7687,2.0498);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0498) rectangle (5.8604,4.323);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.6154) rectangle (7.9042,10.252);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.252) rectangle (5.6333,12.335);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.335) rectangle (6.9958,13.076);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.759) rectangle (6.9958,14.5);
...
\node[black, centered, rotate=90] at (13.72, 4.3229) {Settles};
\node[black, centered, rotate=90] at (13.72, 8.2556) {P Abandons};
\node[black, centered, rotate=90] at (13.72, 10.975) {D Defaults};
