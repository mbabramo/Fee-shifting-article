...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.9094,1.839);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.839) rectangle (1.75,2.8498);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.8498) rectangle (1.9277,5.0073);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.0073) rectangle (1.75,5.2456);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.2456) rectangle (4.9292,5.3911);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.8498) rectangle (8.7928,3.0881);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.0881) rectangle (5.6333,5.2456);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.2456) rectangle (5.969,6.3887);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.8498) rectangle (10.879,3.0881);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.0881) rectangle (10.879,5.2456);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.2456) rectangle (12.242,6.3887);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.3887) rectangle (12.242,6.5342);
...
\node[black, centered, rotate=90] at (13.72, 5.8899) {Settles};
