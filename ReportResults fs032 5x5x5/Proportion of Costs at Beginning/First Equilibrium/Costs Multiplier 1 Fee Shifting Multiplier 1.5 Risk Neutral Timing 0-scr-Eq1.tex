...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.6186,2.3404);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3404) rectangle (2.7881,2.524);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.524) rectangle (1.9576,6.2111);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.2111) rectangle (1.75,10.672);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.672) rectangle (3.8262,10.906);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.5019,2.3404);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3404) rectangle (6.6714,2.524);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.524) rectangle (5.841,6.2113);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.504) rectangle (7.7095,11.738);
...
\node[black, centered, rotate=90] at (13.72, 6.2112) {Settles};
