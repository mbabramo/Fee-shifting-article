...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.7224,1.7938);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7938) rectangle (3.3071,1.8366);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.8366) rectangle (2.8919,3.1903);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.1903) rectangle (2.7881,3.1927);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.1927) rectangle (2.3729,3.6122);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.6122) rectangle (1.8538,5.4859);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.4859) rectangle (1.75,8.7577);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.7577) rectangle (3.8262,9.1001);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.265) rectangle (5.3833,14.306);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.6057,1.9035);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9035) rectangle (7.0867,2.0171);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0171) rectangle (6.6714,2.0207);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0207) rectangle (6.5676,4.0145);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.0145) rectangle (6.1524,4.3074);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.3074) rectangle (5.7371,5.0218);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.526) rectangle (7.7095,12.067);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.402) rectangle (9.2667,14.443);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.443) rectangle (7.1905,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.265) rectangle (13.15,14.361);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.361) rectangle (13.15,14.402);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.402) rectangle (13.15,14.443);
...
\node[black, centered, rotate=90] at (13.72, 5.2538) {Settles};
\node[black, centered, rotate=90] at (13.72, 10.142) {P Abandons};
\node[black, centered, rotate=90] at (13.72, 12.896) {D Defaults};
