...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1388) rectangle (3.3396,2.4394);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.4394) rectangle (2.8854,3.4317);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.4317) rectangle (2.4312,4.645);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.645) rectangle (1.9771,6.7743);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.7743) rectangle (1.75,12.002);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.002) rectangle (4.0208,12.333);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.6771,1.9656);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9656) rectangle (7.2229,2.2474);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2474) rectangle (6.7687,2.9458);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.9458) rectangle (6.3146,3.7143);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.7143) rectangle (5.8604,6.9781);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.138) rectangle (7.9042,13.343);
...
\node[black, centered, rotate=90] at (13.72, 6.8762) {Settles};
