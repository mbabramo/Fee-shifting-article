...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.5037,2.4615);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.4615) rectangle (3.2798,3.0509);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.0509) rectangle (2.056,7.0937);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0937) rectangle (1.75,12.438);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.438) rectangle (4.8096,12.465);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.602) rectangle (5.3833,12.902);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.387,2.4615);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.4615) rectangle (7.1632,3.0509);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.0509) rectangle (5.9393,7.0938);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.52) rectangle (8.693,12.548);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.551) rectangle (9.2667,13.851);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.851) rectangle (6.207,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.602) rectangle (13.15,13.252);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.252) rectangle (13.15,13.551);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.551) rectangle (13.15,13.851);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.851) rectangle (13.15,14.5);
...
\node[black, centered, rotate=90] at (13.72, 7.0938) {Settles};
