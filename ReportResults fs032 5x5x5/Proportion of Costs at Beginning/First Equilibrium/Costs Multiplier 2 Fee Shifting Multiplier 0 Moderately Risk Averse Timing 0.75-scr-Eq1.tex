...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.0208,2.5779);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.5779) rectangle (1.75,6.6286);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.6286) rectangle (2.7719,11.622);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.622) rectangle (1.75,12.862);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.862) rectangle (4.3615,13.329);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.329) rectangle (1.75,14.372);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.372) rectangle (2.7719,14.387);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.427) rectangle (3.1125,14.482);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.6286) rectangle (7.9042,7.8688);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.8688) rectangle (5.6333,12.862);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.862) rectangle (7.3365,13.905);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.905) rectangle (5.6333,14.372);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.372) rectangle (8.926,14.375);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.375) rectangle (6.6552,14.389);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.6286) rectangle (10.879,7.8688);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.8688) rectangle (10.879,12.862);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.862) rectangle (12.242,13.905);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.905) rectangle (12.242,14.372);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.372) rectangle (12.242,14.375);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.375) rectangle (12.242,14.389);
...
\node[black, centered, rotate=90] at (13.72, 4.1893) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 9.7452) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 13.617) {Settles};
