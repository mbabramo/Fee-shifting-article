...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (3.4213,7.9433);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.9433) rectangle (1.75,10.559);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.559) rectangle (1.968,12.895);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.895) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (5.8513,9.4957);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4957) rectangle (5.6333,10.559);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.559) rectangle (7.3047,11.299);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.299) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.425,9.4957);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4957) rectangle (10.425,10.559);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.559) rectangle (10.425,11.299);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.299) rectangle (10.425,13.635);
...
\node[black, centered, rotate=90] at (13.72, 8.7195) {P Abandons};
\node[black, centered, rotate=90] at (13.72, 12.097) {D Defaults};
