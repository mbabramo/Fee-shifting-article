...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.8262,2.4549);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.4549) rectangle (1.75,6.0956);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.0956) rectangle (2.2171,10.132);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.132) rectangle (1.75,10.822);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.822) rectangle (4.0857,10.936);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.0956) rectangle (7.7095,6.7857);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.7857) rectangle (5.6333,10.822);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.822) rectangle (6.3081,11.341);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.463) rectangle (7.1905,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.0956) rectangle (10.879,6.7857);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.7857) rectangle (10.879,10.822);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.822) rectangle (12.242,11.341);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.341) rectangle (12.242,11.455);
...
\node[black, centered, rotate=90] at (13.72, 3.9228) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 8.4589) {D Doesn't Answer};
