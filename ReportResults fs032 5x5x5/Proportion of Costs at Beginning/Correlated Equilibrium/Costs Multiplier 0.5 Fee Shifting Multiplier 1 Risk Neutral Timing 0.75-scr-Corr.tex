...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.258) rectangle (4.5798,3.7337);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.7337) rectangle (3.4619,3.8282);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.8282) rectangle (2.3439,6.3401);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.3401) rectangle (1.75,9.5479);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5479) rectangle (5.3833,10.248);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.258) rectangle (8.4631,3.6668);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.6668) rectangle (7.3452,3.7574);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.7574) rectangle (6.2272,6.4657);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.4657) rectangle (5.6683,8.9777);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.927) rectangle (9.2667,12.628);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.628) rectangle (6.4718,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.258) rectangle (12.242,3.3486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.3486) rectangle (12.242,3.4431);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.4431) rectangle (12.242,6.1514);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.1514) rectangle (12.242,6.6271);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.6271) rectangle (12.242,7.0359);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.0359) rectangle (12.242,9.5479);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.5479) rectangle (13.15,11.226);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.226) rectangle (13.15,11.927);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.927) rectangle (13.15,12.628);
...
\node[black, centered, rotate=90] at (13.72, 6.4029) {Settles};
\node[black, centered, rotate=90] at (13.72, 10.737) {P Loses};
