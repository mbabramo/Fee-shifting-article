...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4198) rectangle (10.879,9.6687);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6687) rectangle (10.879,12.049);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.049) rectangle (12.242,12.421);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.421) rectangle (12.242,13.914);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.914) rectangle (12.242,14.148);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.148) rectangle (12.242,14.378);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.378) rectangle (12.242,14.392);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.392) rectangle (12.242,14.486);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.486) rectangle (13.15,14.489);
...
\node[black, centered, rotate=90] at (13.72, 10.734) {No Answer};
\node[black, centered, rotate=90] at (13.72, 12.981) {Settles};
