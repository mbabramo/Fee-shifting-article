...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.3858,6.2247);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2247) rectangle (2.295,6.8786);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8786) rectangle (2.2042,7.0753);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0753) rectangle (1.75,12.748);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.748) rectangle (2.6583,13.226);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (6.0875,1.7633);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7633) rectangle (5.9967,1.8516);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.8516) rectangle (5.9058,7.423);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.856) rectangle (6.5417,13.928);
...
\node[black, centered, rotate=90] at (13.72, 7.2492) {Settles};
