...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.804) rectangle (4.569,11.226);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.226) rectangle (3.5667,11.51);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.51) rectangle (2.5644,12.014);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.014) rectangle (1.75,13.753);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.753) rectangle (2.3138,13.952);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.952) rectangle (1.75,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.804) rectangle (8.4523,10.981);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.981) rectangle (7.45,11.307);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.307) rectangle (6.4477,12.544);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.544) rectangle (5.9466,13.048);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.048) rectangle (5.6333,13.753);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.753) rectangle (8.7029,13.823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.823) rectangle (6.1971,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.804) rectangle (12.242,12.544);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.544) rectangle (12.242,13.753);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.753) rectangle (12.242,13.823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.823) rectangle (12.242,14.022);
...
\node[black, centered, rotate=90] at (13.72, 12.279) {Settles};
