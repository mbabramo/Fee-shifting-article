...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.8914) rectangle (4.381,6.2239);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2239) rectangle (3.3787,6.2265);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2265) rectangle (2.3764,6.2899);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.2899) rectangle (1.75,8.2693);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.2693) rectangle (4.6316,8.3785);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.3785) rectangle (1.75,8.8797);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.8797) rectangle (2.1259,10.522);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.8914) rectangle (8.2644,5.9108);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.9108) rectangle (7.2621,5.9229);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.9229) rectangle (6.2598,7.8708);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.8708) rectangle (5.7586,7.9342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.9342) rectangle (5.6333,8.2693);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.2693) rectangle (6.0092,8.7705);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.7705) rectangle (5.6333,8.8797);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.8797) rectangle (8.5149,9.3507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.3507) rectangle (6.0092,10.993);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.989) rectangle (11.333,7.9368);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.9368) rectangle (11.333,8.2693);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.2693) rectangle (11.333,8.7705);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.7705) rectangle (11.333,8.8797);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.8797) rectangle (11.333,9.3507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.3507) rectangle (11.333,10.993);
...
\node[black, centered, rotate=90] at (13.72, 7.0803) {Settles};

\node[black, centered, rotate=90] at (13.72, 9.9364) {D Defaults};
