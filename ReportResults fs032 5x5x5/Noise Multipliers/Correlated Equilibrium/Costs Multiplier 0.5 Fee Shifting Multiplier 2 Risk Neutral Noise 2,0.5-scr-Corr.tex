...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.1931,2.2267);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2267) rectangle (3.1908,2.3618);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3618) rectangle (2.1885,4.7911);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,4.7911) rectangle (1.75,6.5576);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5576) rectangle (4.4437,7.1156);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.1156) rectangle (1.75,8.7344);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.7344) rectangle (1.9379,10.462);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.0764,1.8992);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.8992) rectangle (7.0741,1.9097);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9097) rectangle (6.0718,3.5165);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.5165) rectangle (5.6333,6.5576);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5576) rectangle (5.8213,8.1763);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.1763) rectangle (5.6333,8.7344);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.7344) rectangle (8.327,9.1116);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.1116) rectangle (5.8213,10.84);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.9791) rectangle (11.333,4.1283);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.1283) rectangle (11.333,6.5576);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.5576) rectangle (11.333,8.1763);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.1763) rectangle (11.333,8.7344);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.7344) rectangle (11.333,9.1116);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.1116) rectangle (11.333,10.84);
...
\node[black, centered, rotate=90] at (13.72, 7.646) {P Abandons};
\node[black, centered, rotate=90] at (13.72, 9.787) {D Defaults};
