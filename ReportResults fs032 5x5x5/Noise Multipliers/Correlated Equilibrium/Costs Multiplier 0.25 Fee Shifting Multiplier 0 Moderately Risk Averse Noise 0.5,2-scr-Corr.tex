...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.9186,2.2116);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2116) rectangle (3.5667,2.3828);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3828) rectangle (2.2147,5.5124);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.5124) rectangle (1.75,10.84);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.8019,2.4499);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.4499) rectangle (7.45,3.3849);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.3849) rectangle (6.0981,7.0772);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.0772) rectangle (5.6333,10.84);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,5.4423);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.4423) rectangle (11.333,5.904);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.904) rectangle (11.333,7.5388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.5388) rectangle (11.333,10.84);
