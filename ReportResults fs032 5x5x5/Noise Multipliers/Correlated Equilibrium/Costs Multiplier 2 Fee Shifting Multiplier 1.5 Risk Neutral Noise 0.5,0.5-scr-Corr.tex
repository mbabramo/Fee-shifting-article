...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.211) rectangle (3.494,12.516);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.516) rectangle (1.75,12.912);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.912) rectangle (3.6393,13.286);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.286) rectangle (1.75,13.786);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.211) rectangle (6.2147,12.607);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.607) rectangle (5.6333,12.912);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.912) rectangle (6.0693,13.412);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.412) rectangle (5.6333,13.786);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.211) rectangle (11.333,12.607);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.607) rectangle (11.333,12.912);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.912) rectangle (11.333,13.412);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.412) rectangle (11.333,13.786);
