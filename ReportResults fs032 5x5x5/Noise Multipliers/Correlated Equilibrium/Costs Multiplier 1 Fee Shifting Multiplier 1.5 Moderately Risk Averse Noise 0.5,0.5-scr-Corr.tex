...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.211) rectangle (3.0995,12.768);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.768) rectangle (1.75,13.326);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.326) rectangle (4.1376,13.496);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.496) rectangle (1.75,13.883);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.883) rectangle (2.0614,14.27);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.211) rectangle (6.9829,12.768);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.768) rectangle (5.6333,13.326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.326) rectangle (5.9448,13.713);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.713) rectangle (5.6333,13.883);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.883) rectangle (8.021,14.054);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.054) rectangle (5.9448,14.441);
