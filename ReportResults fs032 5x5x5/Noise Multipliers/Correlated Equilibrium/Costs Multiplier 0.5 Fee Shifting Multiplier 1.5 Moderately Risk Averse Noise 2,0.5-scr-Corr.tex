...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.3264,2.8733);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.8733) rectangle (3.7979,4.8242);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.8242) rectangle (3.2694,6.1409);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.1409) rectangle (1.75,11.046);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.046) rectangle (4.5906,11.413);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.413) rectangle (1.75,12.271);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.271) rectangle (1.9482,13.631);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.1527,1.9153);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9153) rectangle (6.6242,2.2355);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2355) rectangle (6.0958,6.6554);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.6554) rectangle (5.6333,11.046);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.046) rectangle (5.8315,11.904);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.904) rectangle (5.6333,12.271);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.271) rectangle (8.4739,12.418);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.418) rectangle (5.8315,13.778);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,2.0702);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.0702) rectangle (11.333,4.0212);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.0212) rectangle (11.333,8.6063);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.6063) rectangle (11.333,11.046);
