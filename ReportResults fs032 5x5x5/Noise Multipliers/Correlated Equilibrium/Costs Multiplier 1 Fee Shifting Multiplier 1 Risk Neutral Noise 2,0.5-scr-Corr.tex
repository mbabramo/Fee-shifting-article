...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.7704) rectangle (4.1344,4.6779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.6779) rectangle (3.226,4.7598);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.7598) rectangle (2.3177,5.3404);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.3404) rectangle (1.75,7.9841);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.9841) rectangle (4.3615,8.2079);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.2079) rectangle (1.75,8.8569);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.8569) rectangle (2.0906,10.488);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.7704) rectangle (8.0177,3.8056);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.8056) rectangle (7.1094,3.8116);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.8116) rectangle (6.201,6.4141);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.4141) rectangle (5.7469,6.9947);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9947) rectangle (5.6333,7.9841);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.9841) rectangle (5.974,8.6331);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.6331) rectangle (5.6333,8.8569);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.8569) rectangle (8.2448,9.2081);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.2081) rectangle (5.974,10.84);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.978) rectangle (6.9958,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.7704) rectangle (11.333,3.8116);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.8116) rectangle (11.333,4.4741);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.4741) rectangle (11.333,7.0766);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.0766) rectangle (11.333,7.9841);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.9841) rectangle (11.333,8.6331);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.6331) rectangle (11.333,8.8569);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.8569) rectangle (11.333,9.2081);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.2081) rectangle (11.333,10.84);
...
\node[black, centered, rotate=90] at (13.72, 5.8773) {Settles};
