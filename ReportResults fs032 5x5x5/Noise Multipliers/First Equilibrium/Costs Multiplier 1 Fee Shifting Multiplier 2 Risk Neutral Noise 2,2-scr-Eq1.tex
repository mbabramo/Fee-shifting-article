...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.6623,1.8018);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.8018) rectangle (1.75,1.9388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.9388) rectangle (2.0368,2.7488);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.7488) rectangle (1.75,3.052);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.052) rectangle (3.7579,3.5553);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.5553) rectangle (1.75,4.9789);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.9789) rectangle (5.3833,6.7785);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9388) rectangle (7.5456,2.242);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.242) rectangle (5.6333,3.052);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.052) rectangle (6.1114,4.4756);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.612) rectangle (9.2667,11.29);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.29) rectangle (7.3544,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.9388) rectangle (10.425,2.242);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.242) rectangle (10.425,3.052);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.052) rectangle (11.333,4.4756);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.4756) rectangle (11.333,4.9789);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.9789) rectangle (13.15,7.8124);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.8124) rectangle (13.15,9.612);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.612) rectangle (13.15,11.29);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.29) rectangle (13.15,14.5);
...
\node[black, centered, rotate=90] at (13.72, 4.0155) {Settles};
\node[black, centered, rotate=90] at (13.72, 7.2955) {P Loses};
\node[black, centered, rotate=90] at (13.72, 12.056) {P Wins};
