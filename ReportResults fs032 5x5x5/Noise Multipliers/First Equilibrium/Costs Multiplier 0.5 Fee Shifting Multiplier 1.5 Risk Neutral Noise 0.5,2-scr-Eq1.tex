...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.3264,1.9269);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.9269) rectangle (3.2694,1.9408);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.9408) rectangle (2.2124,3.5441);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.5441) rectangle (1.75,6.7094);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.7094) rectangle (4.5906,7.0745);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0745) rectangle (1.75,8.7361);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.7361) rectangle (1.9482,9.8462);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.2097,2.2153);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2153) rectangle (7.1527,2.3618);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3618) rectangle (6.0958,4.9153);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.9153) rectangle (5.6333,6.7094);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.7094) rectangle (5.8315,8.371);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.371) rectangle (5.6333,8.7361);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.7361) rectangle (8.4739,9.1122);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.1122) rectangle (5.8315,10.222);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.783) rectangle (6.6242,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,4.45);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.45) rectangle (11.333,4.6408);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.6408) rectangle (11.333,5.1061);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.1061) rectangle (11.333,6.7094);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.7094) rectangle (11.333,8.371);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.371) rectangle (11.333,8.7361);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.7361) rectangle (11.333,9.1122);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.1122) rectangle (11.333,10.222);
...
\node[black, centered, rotate=90] at (13.72, 4.2297) {Settles};
