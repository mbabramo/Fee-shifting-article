...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0161) rectangle (2.1692,12.236);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.236) rectangle (1.75,13.173);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.173) rectangle (4.8244,13.406);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.406) rectangle (1.75,13.885);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.193) rectangle (2.5885,14.375);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0161) rectangle (8.4282,7.953);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.953) rectangle (5.6333,13.173);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.173) rectangle (6.1923,13.652);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.652) rectangle (5.6333,13.885);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.885) rectangle (6.4718,14.068);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.173) rectangle (11.333,13.652);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.652) rectangle (11.333,13.885);
