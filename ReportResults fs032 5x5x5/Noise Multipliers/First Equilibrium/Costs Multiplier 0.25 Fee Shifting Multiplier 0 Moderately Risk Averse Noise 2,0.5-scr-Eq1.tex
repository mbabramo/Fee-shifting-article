...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.9186,2.45);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.45) rectangle (3.5667,3.3849);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.3849) rectangle (2.2147,7.0772);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.8019,2.2116);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2116) rectangle (7.45,2.3828);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3828) rectangle (6.0981,5.5124);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,4.8796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.8796) rectangle (11.333,5.5796);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5796) rectangle (11.333,6.2124);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.2124) rectangle (11.333,10.84);
