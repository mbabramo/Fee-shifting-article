...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.5449,1.9221);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.9221) rectangle (1.75,2.452);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.452) rectangle (2.1692,6.3738);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.3738) rectangle (1.75,6.7637);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.7637) rectangle (4.8244,7.2535);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.2535) rectangle (1.75,9.162);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.162) rectangle (2.1692,9.712);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.481) rectangle (2.5885,14.098);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.452) rectangle (8.4282,2.8418);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.8418) rectangle (5.6333,6.7637);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.7637) rectangle (6.1923,8.6722);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.6722) rectangle (5.6333,9.162);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.162) rectangle (8.8474,9.332);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.332) rectangle (6.0526,9.8821);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.8821) rectangle (6.4718,12.856);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.884) rectangle (6.4718,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.452) rectangle (10.425,2.8418);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.8418) rectangle (10.425,6.7637);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.7637) rectangle (11.333,8.6722);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.6722) rectangle (11.333,9.162);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.162) rectangle (11.333,9.332);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.332) rectangle (11.333,9.8821);
...
\node[black, centered, rotate=90] at (13.72, 4.6078) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 7.9628) {Settles};
