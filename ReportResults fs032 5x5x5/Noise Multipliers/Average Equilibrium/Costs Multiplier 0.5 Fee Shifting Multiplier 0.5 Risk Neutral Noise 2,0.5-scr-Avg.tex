...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.6418,2.0531);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0531) rectangle (3.4554,2.3618);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3618) rectangle (2.269,6.6803);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.351) rectangle (1.9724,14.027);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.027) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.5252,2.3198);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3198) rectangle (7.3388,2.3828);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3828) rectangle (6.1524,3.937);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.937) rectangle (5.6333,8.8673);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.8673) rectangle (5.8558,12.582);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.824) rectangle (6.3007,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.9791) rectangle (11.333,4.5489);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.5489) rectangle (11.333,8.8673);
