...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.0368,6.7297);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.7297) rectangle (1.75,8.1249);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.1249) rectangle (2.7061,8.5016);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.5016) rectangle (1.75,9.827);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.827) rectangle (3.9491,10.15);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.15) rectangle (1.75,13.11);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.11) rectangle (2.0368,13.643);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.5456,3.1451);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.1451) rectangle (5.6333,8.1249);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.1249) rectangle (7.1632,9.4502);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4502) rectangle (5.6333,9.827);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.827) rectangle (5.9202,12.786);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.786) rectangle (5.6333,13.11);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.11) rectangle (7.8325,13.487);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.487) rectangle (5.9202,14.021);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.415) rectangle (7.3544,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.1249) rectangle (11.333,9.4502);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4502) rectangle (11.333,9.827);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.827) rectangle (11.333,12.786);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.786) rectangle (11.333,13.11);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.11) rectangle (11.333,13.487);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.487) rectangle (11.333,14.021);
...
\node[black, centered, rotate=90] at (13.72, 8.9759) {Settles};
\node[black, centered, rotate=90] at (13.72, 11.468) {P Abandons};
