...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.9476) rectangle (10.425,6.7048);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.7048) rectangle (10.425,10.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.943) rectangle (11.333,11.84);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.84) rectangle (11.333,12.579);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.579) rectangle (11.333,13.492);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.492) rectangle (11.333,13.719);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.719) rectangle (11.333,13.879);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.879) rectangle (11.333,14.387);
...
\node[black, centered, rotate=90] at (13.72, 3.8488) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 8.4453) {D Doesn't Answer};
