...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.8304,2.5187);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5187) rectangle (3.5667,2.5285);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5285) rectangle (2.3029,3.9491);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.324) rectangle (2.2239,12.734);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.734) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.7138,2.5187);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.5187) rectangle (7.45,2.5284);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.5284) rectangle (6.1862,3.9492);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.9492) rectangle (5.6333,6.1483);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.1483) rectangle (6.1072,8.5586);
