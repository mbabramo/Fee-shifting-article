...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.3264,2.9633);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.9633) rectangle (3.7979,3.3912);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.3912) rectangle (3.2694,4.0528);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.0528) rectangle (2.7409,4.635);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.635) rectangle (2.2124,6.8463);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8463) rectangle (1.75,11.943);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.943) rectangle (4.5906,12.37);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.37) rectangle (1.75,12.953);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.953) rectangle (1.9482,13.535);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.2097,2.9632);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.9632) rectangle (7.6812,3.3911);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.3911) rectangle (7.1527,4.0527);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.0527) rectangle (6.6242,4.635);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.635) rectangle (6.0958,6.8463);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8463) rectangle (5.6333,11.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.943) rectangle (5.8315,12.525);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.525) rectangle (5.6333,12.953);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.953) rectangle (8.4739,13.381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.381) rectangle (5.8315,13.963);
