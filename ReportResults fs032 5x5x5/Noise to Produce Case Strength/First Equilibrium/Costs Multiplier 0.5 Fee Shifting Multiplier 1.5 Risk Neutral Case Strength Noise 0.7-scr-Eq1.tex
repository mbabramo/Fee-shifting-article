...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.3264,3.3912);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.3912) rectangle (3.2694,3.6597);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.6597) rectangle (2.2124,6.4532);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.4532) rectangle (1.75,11.156);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.2097,3.3911);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.3911) rectangle (7.1527,3.6597);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.6597) rectangle (6.0958,6.4533);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.4533) rectangle (5.6333,11.156);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.7219) rectangle (11.333,8.363);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.363) rectangle (11.333,11.156);
...
\node[black, centered, rotate=90] at (13.72, 6.4532) {Settles};
