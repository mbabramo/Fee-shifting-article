...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.1931,2.9633);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.9633) rectangle (3.692,3.3912);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.3912) rectangle (3.1908,4.0528);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.0528) rectangle (2.6897,4.635);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.635) rectangle (2.1885,6.8463);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8463) rectangle (1.75,11.943);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.943) rectangle (4.4437,12.37);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.37) rectangle (1.75,12.953);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.953) rectangle (1.9379,13.535);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.0764,2.9632);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.9632) rectangle (7.5753,3.3911);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.3911) rectangle (7.0741,4.0527);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.0527) rectangle (6.573,4.635);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.635) rectangle (6.0718,6.8463);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8463) rectangle (5.6333,11.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.943) rectangle (5.8213,12.525);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.525) rectangle (5.6333,12.953);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.953) rectangle (8.327,13.381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.381) rectangle (5.8213,13.963);
