...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.9589) rectangle (2.1259,5.3796);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.3796) rectangle (1.75,6.1483);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.1483) rectangle (4.381,6.7788);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.7788) rectangle (3.8799,7.0661);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0661) rectangle (3.3787,7.6154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.6154) rectangle (2.8776,7.9774);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.9774) rectangle (2.3764,9.0454);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.0454) rectangle (1.75,11.943);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.943) rectangle (4.6316,12.37);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.37) rectangle (1.75,12.953);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.953) rectangle (2.1259,13.535);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.231) rectangle (2.1259,14.377);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.9589) rectangle (8.1391,4.7276);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.7276) rectangle (5.6333,6.1483);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.1483) rectangle (8.2644,6.7788);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.7788) rectangle (7.7632,7.0661);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0661) rectangle (7.2621,7.6154);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.6154) rectangle (6.7609,7.9774);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.9774) rectangle (6.2598,9.0454);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.0454) rectangle (5.7586,10.113);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.113) rectangle (5.6333,11.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.943) rectangle (6.0092,12.525);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.525) rectangle (5.6333,12.953);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.953) rectangle (8.5149,13.381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.381) rectangle (6.0092,13.963);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.963) rectangle (6.0092,14.109);
