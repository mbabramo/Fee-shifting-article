...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.9186,2.5187);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5187) rectangle (3.5667,2.5285);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5285) rectangle (2.2147,3.9491);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.324) rectangle (2.0035,12.734);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.734) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.8019,2.5187);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.5187) rectangle (7.45,2.5284);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.5284) rectangle (6.0981,3.9492);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.9492) rectangle (5.6333,6.1483);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.1483) rectangle (5.8868,8.5586);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.09) rectangle (5.8868,14.5);
