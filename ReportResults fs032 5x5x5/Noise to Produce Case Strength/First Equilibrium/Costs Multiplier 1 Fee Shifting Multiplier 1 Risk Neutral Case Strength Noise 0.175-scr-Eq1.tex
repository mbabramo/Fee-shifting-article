...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2649) rectangle (2.0906,11.679);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.679) rectangle (1.75,11.785);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.785) rectangle (4.2479,11.833);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.833) rectangle (1.75,12.831);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.831) rectangle (4.3615,12.872);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.872) rectangle (1.75,13.272);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.272) rectangle (2.0906,13.712);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.2649) rectangle (7.9042,6.3707);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.3707) rectangle (5.6333,11.785);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.785) rectangle (6.0875,12.783);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.783) rectangle (5.6333,12.831);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.831) rectangle (5.974,13.231);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.231) rectangle (5.6333,13.272);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.272) rectangle (8.2448,13.317);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.317) rectangle (5.974,13.756);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.18) rectangle (6.9958,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.785) rectangle (11.333,12.783);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.783) rectangle (11.333,12.831);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.831) rectangle (11.333,13.231);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.231) rectangle (11.333,13.272);
...
\node[black, centered, rotate=90] at (13.72, 9.0248) {D Doesn't Answer};
