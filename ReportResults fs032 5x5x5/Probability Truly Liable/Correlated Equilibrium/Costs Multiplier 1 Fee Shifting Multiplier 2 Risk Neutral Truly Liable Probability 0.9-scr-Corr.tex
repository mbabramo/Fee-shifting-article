...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.939) rectangle (3.7579,11.356);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.356) rectangle (1.75,11.79);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.79) rectangle (3.9491,12.208);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.939) rectangle (6.1114,11.373);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.373) rectangle (5.6333,11.79);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.79) rectangle (5.9202,12.056);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.939) rectangle (11.333,11.373);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.373) rectangle (11.333,11.79);
