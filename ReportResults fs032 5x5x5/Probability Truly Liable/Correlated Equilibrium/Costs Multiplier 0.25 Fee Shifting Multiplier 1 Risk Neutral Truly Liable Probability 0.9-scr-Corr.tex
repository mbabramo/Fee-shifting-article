...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.712,2.1314);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1314) rectangle (3.4482,2.1992);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1992) rectangle (2.1844,9.702);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.5953,1.9103);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9103) rectangle (7.3315,1.9249);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9249) rectangle (6.0678,2.3348);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.332) rectangle (6.1072,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,2.16);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.16) rectangle (11.333,2.5414);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.5414) rectangle (11.333,2.7163);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.7163) rectangle (11.333,10.287);
