...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.4015,2.1992);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.1992) rectangle (1.75,2.6238);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.6238) rectangle (2.2455,11.132);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.132) rectangle (1.75,11.383);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.383) rectangle (3.0712,13.041);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.041) rectangle (1.75,13.392);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.392) rectangle (3.897,13.695);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.695) rectangle (1.75,13.917);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.917) rectangle (2.2455,14.449);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.449) rectangle (1.75,14.47);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.47) rectangle (5.3833,14.481);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.6238) rectangle (7.2848,2.8746);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.8746) rectangle (5.6333,11.383);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.383) rectangle (6.9545,11.734);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.734) rectangle (5.6333,13.392);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.392) rectangle (6.1288,13.614);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.614) rectangle (5.6333,13.917);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.917) rectangle (7.7803,13.939);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.939) rectangle (6.1288,14.47);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.484) rectangle (9.2667,14.485);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.6238) rectangle (10.425,2.8746);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.8746) rectangle (10.425,11.383);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.383) rectangle (11.333,11.734);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.734) rectangle (11.333,13.392);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.392) rectangle (11.333,13.614);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.614) rectangle (11.333,13.917);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.917) rectangle (11.333,13.939);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.939) rectangle (11.333,14.47);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.47) rectangle (13.15,14.473);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.473) rectangle (13.15,14.484);
...
\node[black, centered, rotate=90] at (13.72, 7.0032) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 12.387) {Settles};
