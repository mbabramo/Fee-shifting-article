...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.457) rectangle (11.333,12.114);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.114) rectangle (11.333,12.286);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.286) rectangle (11.333,13.003);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.003) rectangle (11.333,13.331);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.331) rectangle (11.333,13.487);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.487) rectangle (11.333,13.823);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.823) rectangle (13.15,13.889);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.889) rectangle (13.15,13.912);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.912) rectangle (13.15,14.024);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.024) rectangle (13.15,14.114);
