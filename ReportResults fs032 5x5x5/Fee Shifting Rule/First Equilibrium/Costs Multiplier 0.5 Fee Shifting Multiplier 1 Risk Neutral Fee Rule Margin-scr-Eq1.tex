...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2814) rectangle (4.9641,9.9348);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.9348) rectangle (1.75,11.83);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.83) rectangle (2.1692,13.057);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (6.0526,10.388);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.951) rectangle (8.8474,12.605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.605) rectangle (6.4718,13.273);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.273) rectangle (6.0526,14.5);
