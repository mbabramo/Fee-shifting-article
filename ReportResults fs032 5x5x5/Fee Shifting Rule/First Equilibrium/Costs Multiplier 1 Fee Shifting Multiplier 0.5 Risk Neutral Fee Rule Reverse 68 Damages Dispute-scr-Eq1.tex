...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.9723) rectangle (2.5017,8.9725);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.9725) rectangle (2.5017,8.9784);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.9784) rectangle (2.3764,9.2829);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2829) rectangle (2.2511,9.3008);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.3008) rectangle (2.2511,9.337);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.337) rectangle (2.1259,10.526);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.526) rectangle (2.0006,11.793);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.793) rectangle (1.8753,11.797);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.797) rectangle (1.8753,11.956);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.956) rectangle (1.75,11.956);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.956) rectangle (1.75,12.695);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.849) rectangle (6.7609,9.0336);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.0336) rectangle (6.6356,9.0968);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0968) rectangle (6.5103,9.0968);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.0968) rectangle (6.5103,9.2144);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.2144) rectangle (6.3851,9.583);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.583) rectangle (6.2598,9.583);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.583) rectangle (6.2598,9.7455);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.7455) rectangle (6.1345,11.013);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.013) rectangle (6.0092,12.202);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.202) rectangle (5.8839,12.256);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.256) rectangle (5.7586,12.56);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.56) rectangle (5.6333,12.695);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.844) rectangle (11.333,10.879);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.879) rectangle (11.333,10.879);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.879) rectangle (11.333,11.043);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.043) rectangle (11.333,11.043);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.043) rectangle (11.333,12.695);
...
\node[black, centered, rotate=90] at (13.72, 10.769) {Settles};
