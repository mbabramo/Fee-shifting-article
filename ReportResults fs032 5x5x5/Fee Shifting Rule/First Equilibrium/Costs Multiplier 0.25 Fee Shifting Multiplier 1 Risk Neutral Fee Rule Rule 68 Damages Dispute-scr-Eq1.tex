...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.1322,1.7505);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7505) rectangle (2.8163,1.7529);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7529) rectangle (2.6583,1.7553);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7553) rectangle (2.5004,1.7558);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7558) rectangle (2.3424,2.0937);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0937) rectangle (2.1844,4.1627);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1627) rectangle (2.0264,4.1633);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1633) rectangle (2.0264,4.2265);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.2265) rectangle (1.8685,4.2897);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.7663) rectangle (4.5935,6.7675);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.7675) rectangle (4.3565,6.7675);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.7675) rectangle (3.8036,6.8861);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8861) rectangle (3.5667,6.8863);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8863) rectangle (3.0138,8.2774);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.2774) rectangle (2.7768,8.4655);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.4655) rectangle (2.7768,8.6133);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.6133) rectangle (2.2239,8.7805);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.7805) rectangle (2.2239,9.2707);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2707) rectangle (1.987,11.248);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.248) rectangle (1.987,12.653);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8863) rectangle (7.3233,6.8863);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8863) rectangle (7.3233,6.8863);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.613) rectangle (6.4783,8.613);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.613) rectangle (6.4783,8.6133);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.996) rectangle (5.6333,11.996);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.996) rectangle (5.6333,14.5);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.7663) rectangle (13.15,8.513);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.513) rectangle (13.15,8.513);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.513) rectangle (13.15,10.091);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.091) rectangle (13.15,10.091);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.091) rectangle (13.15,11.766);
