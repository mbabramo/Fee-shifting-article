...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2694,1.8407);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.8407) rectangle (3.1373,1.8436);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.8436) rectangle (3.0052,1.9078);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.9078) rectangle (2.7409,2.298);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.298) rectangle (2.6088,4.1026);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1026) rectangle (2.4767,4.4425);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.4425) rectangle (2.3445,6.2466);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2466) rectangle (2.2124,7.9255);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.9255) rectangle (2.0803,8.2634);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.2634) rectangle (1.9482,10.063);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.063) rectangle (1.8161,10.404);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.08) rectangle (4.7227,13.081);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.081) rectangle (4.1282,13.081);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.081) rectangle (4.0621,13.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.108) rectangle (3.4676,13.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.108) rectangle (3.4015,13.268);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.268) rectangle (2.807,13.467);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.467) rectangle (2.7409,13.471);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.471) rectangle (2.1464,14.071);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.071) rectangle (2.1464,14.244);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.244) rectangle (2.0803,14.244);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.096) rectangle (6.9761,13.096);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.096) rectangle (6.9761,13.096);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.337) rectangle (6.1862,13.337);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.337) rectangle (6.1862,13.337);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.337) rectangle (6.1862,13.337);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.08) rectangle (13.15,14.154);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.154) rectangle (13.15,14.154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.154) rectangle (13.15,14.5);
