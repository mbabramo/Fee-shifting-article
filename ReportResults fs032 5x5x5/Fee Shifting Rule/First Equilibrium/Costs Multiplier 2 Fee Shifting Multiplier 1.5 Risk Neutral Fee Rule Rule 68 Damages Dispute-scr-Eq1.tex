...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.3779) rectangle (7.9042,8.3779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3779) rectangle (7.9042,8.3779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3779) rectangle (7.3365,8.3779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3779) rectangle (6.7687,8.3794);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3794) rectangle (6.201,8.7426);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.7426) rectangle (5.6333,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.81) rectangle (7.45,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.81) rectangle (7.45,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.81) rectangle (7.2229,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.81) rectangle (7.2229,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.81) rectangle (6.9958,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.81) rectangle (6.9958,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.81) rectangle (6.8823,10.82);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.82) rectangle (6.6552,10.827);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.827) rectangle (6.4281,10.83);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.83) rectangle (6.3146,11.301);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.301) rectangle (6.0875,11.47);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.47) rectangle (5.8604,11.539);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.539) rectangle (5.7469,12.901);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.901) rectangle (5.6333,13.041);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.041) rectangle (6.3146,13.041);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.041) rectangle (6.3146,13.042);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.042) rectangle (5.7469,13.183);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.183) rectangle (5.6333,13.402);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.402) rectangle (8.5854,13.402);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.402) rectangle (8.5854,13.402);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.402) rectangle (8.0177,13.402);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.402) rectangle (7.45,13.404);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.404) rectangle (6.8823,13.606);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.606) rectangle (6.3146,13.834);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.834) rectangle (9.2667,13.834);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.834) rectangle (9.2667,13.834);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.834) rectangle (8.699,13.834);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.834) rectangle (8.699,13.834);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.834) rectangle (8.1313,13.834);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.834) rectangle (8.1313,13.838);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.838) rectangle (7.5635,13.955);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.955) rectangle (7.5635,13.955);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.955) rectangle (7.5635,13.955);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.955) rectangle (6.9958,14.308);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.308) rectangle (6.9958,14.309);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.309) rectangle (6.4281,14.39);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.39) rectangle (6.4281,14.405);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.405) rectangle (6.0875,14.405);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.405) rectangle (6.0875,14.405);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.3779) rectangle (10.425,8.3779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3779) rectangle (10.425,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.81) rectangle (11.333,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.81) rectangle (11.333,12.738);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.738) rectangle (11.333,12.738);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.738) rectangle (11.333,12.813);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.813) rectangle (11.333,12.813);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.813) rectangle (11.333,13.041);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.041) rectangle (11.333,13.041);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.041) rectangle (11.333,13.402);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.402) rectangle (11.333,13.402);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.402) rectangle (11.333,13.834);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.834) rectangle (13.15,13.834);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.834) rectangle (13.15,14.483);
...
\node[black, centered, rotate=90] at (13.72, 5.0639) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 9.5938) {No Answer};
\node[black, centered, rotate=90] at (13.72, 11.925) {Settles};
