...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.647) rectangle (11.333,12.763);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.763) rectangle (11.333,12.763);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.763) rectangle (11.333,12.911);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.911) rectangle (11.333,12.911);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.911) rectangle (11.333,13.354);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.354) rectangle (11.333,13.354);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.354) rectangle (11.333,13.745);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.745) rectangle (11.333,13.745);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.745) rectangle (11.333,13.903);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.903) rectangle (13.15,13.903);
