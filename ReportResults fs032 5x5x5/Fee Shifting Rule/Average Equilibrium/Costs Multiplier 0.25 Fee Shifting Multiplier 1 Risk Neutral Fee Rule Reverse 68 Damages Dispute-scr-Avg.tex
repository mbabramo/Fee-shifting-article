...
\draw[black, very thin] (13.35,10.137) -- (13.45,10.137);
\node[anchor=west] at (13.35, 10.137) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0953) rectangle (2.5004,2.1608);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1608) rectangle (2.5004,2.1608);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1608) rectangle (2.3424,2.2139);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2139) rectangle (2.1844,4.6167);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.6167) rectangle (2.0264,4.68);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.68) rectangle (2.0264,4.9079);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.9079) rectangle (1.8685,6.3703);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.3703) rectangle (1.75,6.3703);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.3703) rectangle (1.75,10.137);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.137) rectangle (5.0279,10.137);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.137) rectangle (4.238,10.137);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.137) rectangle (3.4482,10.137);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.137) rectangle (2.6583,10.189);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.189) rectangle (1.8685,10.525);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7501) rectangle (7.0156,1.7516);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7516) rectangle (6.8576,1.7516);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7516) rectangle (6.6996,1.7516);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7516) rectangle (6.6996,1.7516);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7516) rectangle (6.6996,1.8592);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.8592) rectangle (6.5417,1.9257);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9257) rectangle (6.3837,1.9257);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.9257) rectangle (6.3837,2.2468);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.2468) rectangle (6.3837,2.2491);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.2491) rectangle (6.2257,2.8665);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.8665) rectangle (6.0678,2.8665);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.8665) rectangle (6.0678,4.2599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.2599) rectangle (6.0678,4.2604);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.2604) rectangle (5.9098,4.2604);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.2604) rectangle (5.9098,5.5162);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5162) rectangle (5.7518,6.9787);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9787) rectangle (5.6333,10.137);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.137) rectangle (5.7518,10.137);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.137) rectangle (5.7518,10.473);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.473) rectangle (5.6333,10.525);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.7452) rectangle (11.333,10.137);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.137) rectangle (11.333,10.137);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.137) rectangle (11.333,10.525);
...
\draw[black, dotted] (1.5,10.137) -- (13.4,10.137);
...
\node[black, centered, rotate=90] at (13.72, 5.9433) {Settles};
