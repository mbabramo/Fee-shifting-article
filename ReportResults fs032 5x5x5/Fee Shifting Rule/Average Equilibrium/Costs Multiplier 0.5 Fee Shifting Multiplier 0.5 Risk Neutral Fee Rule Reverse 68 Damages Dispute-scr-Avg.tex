...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.4554,1.7509);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7509) rectangle (3.3071,1.751);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.751) rectangle (3.1588,1.7511);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7511) rectangle (3.0105,1.7511);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7511) rectangle (3.0105,1.754);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.754) rectangle (2.8622,1.7573);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7573) rectangle (2.7139,2.0981);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0981) rectangle (2.5656,2.1641);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1641) rectangle (2.4173,2.2308);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2308) rectangle (2.269,2.2308);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2308) rectangle (2.269,2.5678);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5678) rectangle (2.269,4.2649);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.2649) rectangle (2.1207,4.5915);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.5915) rectangle (1.9724,6.054);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.054) rectangle (1.8241,7.3095);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.3095) rectangle (1.75,7.3095);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.3095) rectangle (1.75,10.09);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.09) rectangle (1.9724,10.459);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7508) rectangle (7.0422,1.7508);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7508) rectangle (7.0422,1.7512);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7512) rectangle (6.8939,1.7512);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7512) rectangle (6.7456,1.7512);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7512) rectangle (6.7456,1.8437);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.8437) rectangle (6.5973,1.9075);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9075) rectangle (6.449,1.9075);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.9075) rectangle (6.449,2.2944);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.2944) rectangle (6.449,2.2963);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.2963) rectangle (6.3007,2.5732);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.5732) rectangle (6.3007,2.8508);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.8508) rectangle (6.1524,2.8508);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.8508) rectangle (6.1524,4.5298);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.5298) rectangle (6.1524,4.5303);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.5303) rectangle (6.0041,5.7858);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.7858) rectangle (5.8558,7.2483);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.2483) rectangle (5.7075,7.5229);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.5229) rectangle (5.7075,7.5749);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.5749) rectangle (5.6333,10.09);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.09) rectangle (8.8218,10.09);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.09) rectangle (8.8218,10.09);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.09) rectangle (8.0803,10.09);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.09) rectangle (7.3388,10.09);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.09) rectangle (6.5973,10.156);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.156) rectangle (5.8558,10.525);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.75) rectangle (11.333,4.4436);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.4436) rectangle (11.333,4.4436);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.4436) rectangle (11.333,8.0538);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.0538) rectangle (11.333,8.0538);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.0538) rectangle (11.333,10.09);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.09) rectangle (11.333,10.09);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.09) rectangle (11.333,10.525);
...
\node[black, centered, rotate=90] at (13.72, 5.9199) {Settles};
