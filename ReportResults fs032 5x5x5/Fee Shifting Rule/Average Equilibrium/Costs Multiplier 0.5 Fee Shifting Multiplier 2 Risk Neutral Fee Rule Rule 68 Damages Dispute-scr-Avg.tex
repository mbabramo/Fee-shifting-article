...
\draw[black, very thin] (13.35,9.6161) -- (13.45,9.6161);
\node[anchor=west] at (13.35, 9.6161) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7537) rectangle (2.9402,1.8178);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.8178) rectangle (2.8149,1.8178);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.8178) rectangle (2.6897,2.0971);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0971) rectangle (2.5644,2.3722);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3722) rectangle (2.4391,2.4359);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.4359) rectangle (2.4391,2.4359);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.4359) rectangle (2.3138,4.2049);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.2049) rectangle (2.1885,4.2049);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.2049) rectangle (2.1885,6.2706);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2706) rectangle (2.0632,6.6652);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.6652) rectangle (1.9379,6.9396);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.9396) rectangle (1.8126,6.944);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.944) rectangle (1.8126,6.944);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.944) rectangle (1.75,6.944);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.944) rectangle (1.75,9.6161);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.6161) rectangle (4.4437,9.6161);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.6161) rectangle (3.8172,9.6161);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.6161) rectangle (3.1908,9.6164);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.6164) rectangle (2.5644,9.6566);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.6566) rectangle (1.9379,9.8717);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.8717) rectangle (1.75,9.8717);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7505) rectangle (6.9761,1.7505);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7505) rectangle (6.8181,1.7505);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7505) rectangle (6.8181,1.7506);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7506) rectangle (6.6601,1.7512);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7512) rectangle (6.5022,1.7512);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7512) rectangle (6.5022,1.7549);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7549) rectangle (6.5022,1.7573);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7573) rectangle (6.3442,1.7573);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7573) rectangle (6.3442,2.0951);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0951) rectangle (6.1862,2.0951);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.0951) rectangle (6.1862,4.4221);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.4221) rectangle (6.1862,4.4221);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.4221) rectangle (6.0283,4.4265);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.4265) rectangle (5.8703,4.7009);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.7009) rectangle (5.7123,5.0322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.0322) rectangle (5.7123,5.0955);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.0955) rectangle (5.6333,9.6161);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.6161) rectangle (5.8703,9.6161);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6161) rectangle (5.8703,9.8312);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8312) rectangle (5.6333,9.8717);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.75) rectangle (11.333,2.432);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.432) rectangle (11.333,2.432);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.432) rectangle (11.333,7.143);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.143) rectangle (11.333,7.143);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.143) rectangle (11.333,9.6161);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.6161) rectangle (11.333,9.6161);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6161) rectangle (11.333,9.8717);
...
\draw[black, dotted] (1.5,9.6161) -- (13.4,9.6161);
...
\node[black, centered, rotate=90] at (13.72, 5.6831) {Settles};
