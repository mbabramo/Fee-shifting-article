...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.858) rectangle (3.7318,12.073);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.073) rectangle (3.4015,12.073);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.073) rectangle (3.2364,12.073);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.073) rectangle (3.2364,12.073);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.073) rectangle (3.0712,12.073);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.073) rectangle (2.9061,12.073);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.073) rectangle (2.7409,12.073);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.073) rectangle (1.75,12.607);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.607) rectangle (3.897,12.843);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.843) rectangle (1.75,13.364);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.364) rectangle (2.2455,13.684);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.858) rectangle (7.2848,11.858);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.858) rectangle (7.1197,11.858);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.858) rectangle (6.9545,11.858);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.858) rectangle (6.7894,11.858);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.858) rectangle (6.6242,11.858);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.858) rectangle (6.2939,12.392);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.392) rectangle (5.6333,12.607);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.607) rectangle (6.1288,13.128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.128) rectangle (5.6333,13.364);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.364) rectangle (7.7803,13.503);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.503) rectangle (6.1288,13.823);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.858) rectangle (11.333,11.858);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.858) rectangle (11.333,11.858);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.858) rectangle (11.333,12.392);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.392) rectangle (11.333,12.607);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.607) rectangle (11.333,12.607);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.607) rectangle (11.333,12.607);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.607) rectangle (11.333,13.128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.128) rectangle (11.333,13.364);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.364) rectangle (11.333,13.503);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.503) rectangle (11.333,13.823);
