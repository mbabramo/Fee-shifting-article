...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.6184,2.5187);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5187) rectangle (3.3946,2.5285);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.5285) rectangle (2.1707,3.9491);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.5018,2.5187);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.5187) rectangle (7.2779,2.5284);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.5284) rectangle (6.054,3.9492);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.09) rectangle (6.207,14.5);
