...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2649) rectangle (2.0614,11.692);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.692) rectangle (1.75,11.8);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.8) rectangle (4.0338,11.845);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.845) rectangle (1.75,12.814);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.814) rectangle (4.1376,12.861);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.861) rectangle (1.75,13.296);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.296) rectangle (2.0614,13.728);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.728) rectangle (1.75,13.773);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.773) rectangle (5.3833,13.824);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.2649) rectangle (7.7095,6.3735);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.3735) rectangle (5.6333,11.8);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.8) rectangle (6.0486,12.77);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.77) rectangle (5.6333,12.814);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.814) rectangle (5.9448,13.249);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.249) rectangle (5.6333,13.296);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.296) rectangle (8.021,13.341);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.341) rectangle (5.9448,13.773);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.135) rectangle (9.2667,14.185);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.2649) rectangle (10.425,6.3735);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.3735) rectangle (10.425,11.8);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.8) rectangle (11.333,12.77);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.77) rectangle (11.333,12.814);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.814) rectangle (11.333,13.249);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.249) rectangle (11.333,13.296);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.296) rectangle (11.333,13.341);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.341) rectangle (11.333,13.773);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.773) rectangle (13.15,14.084);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.084) rectangle (13.15,14.135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.135) rectangle (13.15,14.185);
...
\node[black, centered, rotate=90] at (13.72, 9.0327) {D Doesn't Answer};
