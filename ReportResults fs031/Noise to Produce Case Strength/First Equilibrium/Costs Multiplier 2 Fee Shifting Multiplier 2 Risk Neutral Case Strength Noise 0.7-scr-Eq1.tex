...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.0476,3.2684);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.2684) rectangle (1.75,5.828);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.828) rectangle (2.1393,9.1175);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.1175) rectangle (1.75,11.155);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.155) rectangle (3.372,11.564);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.564) rectangle (1.75,12.152);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.152) rectangle (3.4369,12.656);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.656) rectangle (1.75,13.278);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.278) rectangle (2.1393,13.458);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.828) rectangle (6.931,7.8657);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.8657) rectangle (5.6333,11.155);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.155) rectangle (6.0875,11.743);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.743) rectangle (5.6333,12.152);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.152) rectangle (6.0226,12.774);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.774) rectangle (5.6333,13.278);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.278) rectangle (7.3202,13.416);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.416) rectangle (6.0226,13.595);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.21) rectangle (7.969,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.828) rectangle (10.425,7.8657);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.8657) rectangle (10.425,11.155);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.155) rectangle (11.333,11.743);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.743) rectangle (11.333,12.152);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.152) rectangle (11.333,12.774);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.774) rectangle (11.333,13.278);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.278) rectangle (11.333,13.416);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.416) rectangle (11.333,13.595);
...
\node[black, centered, rotate=90] at (13.72, 3.789) {P Doesn't File};
