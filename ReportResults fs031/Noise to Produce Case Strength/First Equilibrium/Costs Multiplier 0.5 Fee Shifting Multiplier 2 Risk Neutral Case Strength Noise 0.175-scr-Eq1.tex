...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.2557,1.8037);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.8037) rectangle (1.75,6.0565);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.0565) rectangle (1.9379,10.71);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.71) rectangle (1.75,10.761);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.761) rectangle (4.3184,10.817);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.817) rectangle (1.75,11.932);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.932) rectangle (4.4437,12.003);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.003) rectangle (1.75,12.512);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.512) rectangle (1.9379,13.681);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.0565) rectangle (8.1391,6.1076);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.1076) rectangle (5.6333,10.761);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.761) rectangle (5.9466,11.876);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.876) rectangle (5.6333,11.932);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.932) rectangle (5.8213,12.44);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.44) rectangle (5.6333,12.512);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.512) rectangle (8.327,12.587);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.587) rectangle (5.8213,13.756);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.0565) rectangle (10.425,6.1076);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.1076) rectangle (10.425,10.761);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.761) rectangle (11.333,11.876);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.876) rectangle (11.333,11.932);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.932) rectangle (11.333,12.44);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.44) rectangle (11.333,12.512);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.512) rectangle (11.333,12.587);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.587) rectangle (11.333,13.756);
...
\node[black, centered, rotate=90] at (13.72, 3.9033) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 8.409) {D Doesn't Answer};
