...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.9073,2.463);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.463) rectangle (3.5667,4.8477);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.8477) rectangle (3.226,7.9825);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.7906,2.1332);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.1332) rectangle (7.45,3.89);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.89) rectangle (7.1094,8.0238);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,3.5068);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.5068) rectangle (11.333,5.8915);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.8915) rectangle (11.333,10.408);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.408) rectangle (11.333,14.256);
