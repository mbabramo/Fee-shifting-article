...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.0476,1.9102);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.9102) rectangle (1.75,2.1124);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1124) rectangle (2.1393,11.993);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.993) rectangle (1.75,12.391);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.391) rectangle (3.372,12.847);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.847) rectangle (1.75,13.267);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.267) rectangle (3.4369,13.587);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.587) rectangle (1.75,13.736);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.736) rectangle (2.1393,13.862);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.862) rectangle (1.75,13.879);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.879) rectangle (5.3833,14.1);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.1124) rectangle (6.931,2.5101);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.5101) rectangle (5.6333,12.391);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.391) rectangle (6.0875,12.811);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.811) rectangle (5.6333,13.267);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.267) rectangle (6.0226,13.416);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.416) rectangle (5.6333,13.736);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.736) rectangle (7.3202,13.753);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.753) rectangle (6.0226,13.879);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.164) rectangle (9.2667,14.189);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.189) rectangle (7.969,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.1124) rectangle (10.425,2.5101);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.5101) rectangle (10.425,12.391);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.391) rectangle (11.333,12.811);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.811) rectangle (11.333,13.267);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.267) rectangle (11.333,13.416);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.416) rectangle (11.333,13.736);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.736) rectangle (11.333,13.753);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.753) rectangle (11.333,13.879);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.879) rectangle (13.15,13.943);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.943) rectangle (13.15,14.164);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.164) rectangle (13.15,14.189);
...
\node[black, centered, rotate=90] at (13.72, 7.2514) {D Doesn't Answer};
