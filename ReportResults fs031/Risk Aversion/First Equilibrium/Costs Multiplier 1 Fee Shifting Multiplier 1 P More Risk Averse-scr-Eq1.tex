...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8406) rectangle (2.0906,8.9276);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.9276) rectangle (1.75,9.1314);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1314) rectangle (3.5667,10.585);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.585) rectangle (1.75,11.561);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.561) rectangle (4.3615,11.738);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.738) rectangle (1.75,12.316);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.316) rectangle (2.0906,14.063);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8406) rectangle (7.9042,7.0444);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.0444) rectangle (5.6333,9.1314);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1314) rectangle (6.7687,10.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.108) rectangle (5.6333,11.561);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.561) rectangle (5.974,12.14);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.14) rectangle (5.6333,12.316);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.316) rectangle (8.2448,12.64);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.64) rectangle (5.974,14.387);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.464) rectangle (6.9958,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8406) rectangle (10.425,7.0444);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.0444) rectangle (10.425,9.1314);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1314) rectangle (11.333,10.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.108) rectangle (11.333,11.561);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.561) rectangle (11.333,12.14);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.14) rectangle (11.333,12.316);
...
\node[black, centered, rotate=90] at (13.72, 7.986) {No Answer};
\node[black, centered, rotate=90] at (13.72, 10.346) {Settles};
