...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (4.4437,9.6735);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.6735) rectangle (1.75,11.135);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.135) rectangle (1.9379,12.597);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (5.8213,10.622);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.622) rectangle (5.6333,11.135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.135) rectangle (8.327,11.648);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.648) rectangle (5.8213,13.11);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (11.333,10.622);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.622) rectangle (11.333,11.135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.135) rectangle (11.333,11.648);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.648) rectangle (11.333,13.11);
