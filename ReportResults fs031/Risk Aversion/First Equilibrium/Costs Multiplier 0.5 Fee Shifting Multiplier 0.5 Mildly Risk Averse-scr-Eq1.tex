...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1507) rectangle (1.9724,6.3017);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.3017) rectangle (1.75,6.5342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5342) rectangle (4.7901,6.9483);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.9483) rectangle (3.4554,7.0846);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0846) rectangle (2.1207,8.9949);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.978) rectangle (1.9724,14.02);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1507) rectangle (8.5993,4.3832);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.3832) rectangle (5.6333,6.5342);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5342) rectangle (8.6735,6.9482);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.9482) rectangle (7.3388,7.0846);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0846) rectangle (6.0041,8.995);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.995) rectangle (5.7075,10.905);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.905) rectangle (5.6333,11.456);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.456) rectangle (5.8558,12.498);
