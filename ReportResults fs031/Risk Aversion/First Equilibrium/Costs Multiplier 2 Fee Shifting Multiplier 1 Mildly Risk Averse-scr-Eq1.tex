...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.4015,2.5628);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.5628) rectangle (1.75,6.6881);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.6881) rectangle (2.2455,11.336);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.336) rectangle (1.75,12.255);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.255) rectangle (3.1538,12.6);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.6) rectangle (1.75,13.027);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.027) rectangle (3.897,13.277);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.277) rectangle (1.75,14.021);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.021) rectangle (2.2455,14.248);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.248) rectangle (1.75,14.336);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.336) rectangle (5.3833,14.365);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.6881) rectangle (7.2848,7.6068);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.6068) rectangle (5.6333,12.255);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.255) rectangle (6.872,12.681);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.681) rectangle (5.6333,13.027);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.027) rectangle (6.1288,13.77);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.77) rectangle (5.6333,14.021);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.021) rectangle (7.7803,14.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.108) rectangle (6.1288,14.336);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.41) rectangle (9.2667,14.439);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.6881) rectangle (10.425,7.6068);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.6068) rectangle (10.425,12.255);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.255) rectangle (11.333,12.681);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.681) rectangle (11.333,13.027);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.027) rectangle (11.333,13.77);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.77) rectangle (11.333,14.021);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.021) rectangle (11.333,14.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.108) rectangle (11.333,14.336);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.336) rectangle (13.15,14.381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.381) rectangle (13.15,14.41);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.41) rectangle (13.15,14.439);
...
\node[black, centered, rotate=90] at (13.72, 4.219) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 9.4716) {D Doesn't Answer};
