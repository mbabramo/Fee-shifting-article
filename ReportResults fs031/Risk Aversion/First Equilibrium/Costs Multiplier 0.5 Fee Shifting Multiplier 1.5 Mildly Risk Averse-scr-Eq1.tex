...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.8663) rectangle (4.4585,8.1892);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.1892) rectangle (3.2694,8.2304);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.2304) rectangle (2.0803,8.8954);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.8954) rectangle (1.75,10.682);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.682) rectangle (4.5906,10.867);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.867) rectangle (1.75,11.441);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.441) rectangle (1.9482,12.084);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.084) rectangle (1.75,12.338);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.338) rectangle (5.3833,12.684);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.8663) rectangle (8.3418,8.0595);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.0595) rectangle (7.1527,8.1107);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.1107) rectangle (5.9636,9.6531);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6531) rectangle (5.6994,10.318);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.318) rectangle (5.6333,10.682);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.682) rectangle (5.8315,11.256);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.256) rectangle (5.6333,11.441);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.441) rectangle (8.4739,11.695);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.695) rectangle (5.8315,12.338);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.48) rectangle (9.2667,13.827);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.827) rectangle (6.6242,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.8663) rectangle (11.333,9.4087);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4087) rectangle (11.333,9.7316);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.7316) rectangle (11.333,9.7828);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.7828) rectangle (11.333,9.8239);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.8239) rectangle (11.333,10.017);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.017) rectangle (11.333,10.682);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.682) rectangle (11.333,11.256);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.256) rectangle (11.333,11.441);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.441) rectangle (11.333,11.695);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.695) rectangle (11.333,12.338);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.338) rectangle (13.15,13.134);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.134) rectangle (13.15,13.48);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.48) rectangle (13.15,13.827);
...
\node[black, centered, rotate=90] at (13.72, 9.2743) {Settles};
