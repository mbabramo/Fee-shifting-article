...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.0906,3.8726);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.8726) rectangle (1.75,4.1222);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1222) rectangle (3.226,4.5456);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.5456) rectangle (2.7719,5.711);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.711) rectangle (2.3177,7.9234);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.9234) rectangle (1.75,11.76);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.76) rectangle (4.3615,11.972);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.972) rectangle (1.75,14.022);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.022) rectangle (2.0906,14.223);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1222) rectangle (8.0177,4.6075);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.6075) rectangle (7.5635,6.0418);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.0418) rectangle (7.1094,7.9586);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.9586) rectangle (5.7469,10.171);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.171) rectangle (5.6333,11.76);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.76) rectangle (5.974,13.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.81) rectangle (5.6333,14.022);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.022) rectangle (8.2448,14.188);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.188) rectangle (5.974,14.389);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1222) rectangle (11.333,7.9586);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.9586) rectangle (11.333,11.76);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.76) rectangle (11.333,13.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.81) rectangle (11.333,14.022);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.022) rectangle (11.333,14.188);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.188) rectangle (11.333,14.389);
...
\node[black, centered, rotate=90] at (13.72, 7.941) {Settles};
\node[black, centered, rotate=90] at (13.72, 12.891) {P Abandons};
