...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8406) rectangle (2.3729,11.151);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.151) rectangle (1.75,11.908);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.908) rectangle (4.3452,12.083);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.083) rectangle (1.75,12.512);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.512) rectangle (4.449,12.571);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.571) rectangle (1.75,12.724);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.724) rectangle (2.3729,13.004);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.805) rectangle (2.3729,14.267);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8406) rectangle (7.9042,7.5979);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.5979) rectangle (5.6333,11.908);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.908) rectangle (6.0875,12.337);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.337) rectangle (5.6333,12.512);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.512) rectangle (5.974,12.665);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.665) rectangle (5.6333,12.724);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.724) rectangle (8.2448,12.829);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.829) rectangle (5.974,13.11);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.11) rectangle (5.974,13.572);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8406) rectangle (10.728,7.5979);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.5979) rectangle (10.728,11.908);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.908) rectangle (11.333,12.337);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.337) rectangle (11.333,12.512);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.512) rectangle (11.333,12.665);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.665) rectangle (11.333,12.724);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.724) rectangle (11.333,12.829);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.829) rectangle (11.333,13.11);
...
\node[black, centered, rotate=90] at (13.72, 9.3743) {D Doesn't Answer};
