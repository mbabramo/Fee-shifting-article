...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.1251) rectangle (7.2848,8.9221);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.9221) rectangle (5.6333,13.374);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.374) rectangle (6.2114,13.488);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.488) rectangle (5.6333,13.548);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.548) rectangle (6.1288,13.844);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.844) rectangle (5.6333,14.028);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.028) rectangle (7.7803,14.062);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.062) rectangle (6.1288,14.133);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.133) rectangle (6.1288,14.224);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.224) rectangle (5.6333,14.287);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.287) rectangle (9.2667,14.35);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.35) rectangle (7.6152,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.1251) rectangle (10.728,8.9221);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.9221) rectangle (10.728,13.374);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.374) rectangle (11.333,13.488);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.488) rectangle (11.333,13.548);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.548) rectangle (11.333,13.844);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.844) rectangle (11.333,14.028);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.028) rectangle (11.333,14.062);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.062) rectangle (11.333,14.133);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.133) rectangle (13.15,14.224);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.224) rectangle (13.15,14.287);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.287) rectangle (13.15,14.35);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.35) rectangle (13.15,14.5);
...
\node[black, centered, rotate=90] at (13.72, 10.749) {D Doesn't Answer};
