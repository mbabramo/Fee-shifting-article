...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1507) rectangle (2.1449,5.1587);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.1587) rectangle (1.75,5.2457);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.3723) rectangle (2.2239,13.347);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.347) rectangle (1.75,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1507) rectangle (8.9709,4.2377);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.2377) rectangle (5.6333,5.2457);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.2457) rectangle (5.8868,8.2216);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.525) rectangle (5.8868,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1507) rectangle (11.333,4.2377);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.2377) rectangle (11.333,5.2457);
