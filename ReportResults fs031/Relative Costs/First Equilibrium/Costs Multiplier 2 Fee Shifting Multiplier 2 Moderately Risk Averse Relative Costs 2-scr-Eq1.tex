...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.8186,2.0713);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.0713) rectangle (1.75,4.5994);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.5994) rectangle (2.3912,9.1336);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.1336) rectangle (1.75,10.103);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.103) rectangle (2.7652,11.47);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.47) rectangle (1.75,14.142);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.142) rectangle (3.4598,14.164);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.164) rectangle (1.75,14.337);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.337) rectangle (2.3912,14.468);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.5994) rectangle (6.5417,5.5688);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5688) rectangle (5.6333,10.103);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.103) rectangle (6.4963,12.776);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.776) rectangle (5.6333,14.142);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.142) rectangle (5.9058,14.315);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.315) rectangle (5.6333,14.337);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.337) rectangle (6.8142,14.369);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.369) rectangle (5.9058,14.499);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.5994) rectangle (10.728,5.5688);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5688) rectangle (10.728,10.103);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.103) rectangle (11.333,12.776);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.776) rectangle (11.333,14.142);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.142) rectangle (11.333,14.315);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.315) rectangle (11.333,14.337);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.337) rectangle (11.333,14.369);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.369) rectangle (11.333,14.499);
...
\node[black, centered, rotate=90] at (13.72, 3.1747) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 7.3512) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 12.123) {Settles};
