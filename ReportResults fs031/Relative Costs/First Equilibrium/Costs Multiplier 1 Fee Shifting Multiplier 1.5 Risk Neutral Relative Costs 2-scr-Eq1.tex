...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.5224,2.4006);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.4006) rectangle (1.75,6.107);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.107) rectangle (2.2817,10.738);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.738) rectangle (1.75,11.684);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.684) rectangle (3.9654,11.765);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.765) rectangle (1.75,12.106);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.106) rectangle (4.0541,12.316);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.316) rectangle (1.75,12.938);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.938) rectangle (2.2817,13.193);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.193) rectangle (1.75,13.342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.342) rectangle (5.3833,13.536);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.107) rectangle (7.2848,7.0536);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.0536) rectangle (5.6333,11.684);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.684) rectangle (5.9636,12.025);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.025) rectangle (5.6333,12.106);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.106) rectangle (5.8811,12.728);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.728) rectangle (5.6333,12.938);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.938) rectangle (7.5326,13.087);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.087) rectangle (5.8811,13.342);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.952) rectangle (9.2667,14.146);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.146) rectangle (7.6152,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.107) rectangle (10.728,7.0536);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.0536) rectangle (10.728,11.684);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.684) rectangle (11.333,12.025);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.025) rectangle (11.333,12.106);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.106) rectangle (11.333,12.728);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.728) rectangle (11.333,12.938);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.938) rectangle (11.333,13.087);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.087) rectangle (11.333,13.342);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.342) rectangle (13.15,13.757);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.757) rectangle (13.15,13.952);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.952) rectangle (13.15,14.146);
...
\node[black, centered, rotate=90] at (13.72, 3.9285) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 8.8957) {D Doesn't Answer};
