...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.1325,1.991);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.991) rectangle (1.75,4.1507);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1507) rectangle (2.1074,6.3017);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.3017) rectangle (1.75,6.5342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5342) rectangle (3.4178,7.0092);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0092) rectangle (2.8221,7.3044);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.3044) rectangle (2.2265,9.0559);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.0559) rectangle (1.75,10.66);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.66) rectangle (4.4899,10.88);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.88) rectangle (1.75,12.365);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.365) rectangle (2.1074,13.445);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1507) rectangle (7.9042,4.3832);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.3832) rectangle (5.6333,6.5342);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5342) rectangle (7.9609,6.8586);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8586) rectangle (7.3932,7.0846);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0846) rectangle (6.8255,8.1388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.1388) rectangle (5.6901,9.8903);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8903) rectangle (5.6333,10.66);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.66) rectangle (5.8036,12.146);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.146) rectangle (5.6333,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.365) rectangle (8.0745,12.94);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.94) rectangle (5.8036,14.021);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1507) rectangle (10.728,4.3832);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.3832) rectangle (10.728,6.5342);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.5342) rectangle (11.333,8.1388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.1388) rectangle (11.333,10.66);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.66) rectangle (11.333,12.146);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.146) rectangle (11.333,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.365) rectangle (11.333,12.94);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.94) rectangle (11.333,14.021);
...
\node[black, centered, rotate=90] at (13.72, 8.5973) {Settles};
