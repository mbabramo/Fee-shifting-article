...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.0208,2.6219);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.6219) rectangle (1.75,6.8797);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8797) rectangle (2.4312,10.639);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.639) rectangle (1.75,11.191);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.191) rectangle (4.5885,11.485);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.485) rectangle (1.75,12.109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.109) rectangle (5.3833,12.481);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.481) rectangle (1.75,13.051);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.051) rectangle (3.1125,14.129);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8797) rectangle (8.4282,7.4318);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.4318) rectangle (5.6333,11.191);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.191) rectangle (6.1923,11.816);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.816) rectangle (5.6333,12.109);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.109) rectangle (6.4718,12.679);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.679) rectangle (5.6333,13.051);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.051) rectangle (9.2667,13.422);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.422) rectangle (6.4718,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8797) rectangle (10.728,7.4318);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.4318) rectangle (10.728,11.191);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.191) rectangle (11.333,11.816);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.816) rectangle (11.333,12.109);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.109) rectangle (13.15,12.679);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.679) rectangle (13.15,13.051);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.051) rectangle (13.15,13.422);
...
\node[black, centered, rotate=90] at (13.72, 4.3149) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 9.0356) {D Doesn't Answer};
