...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8406) rectangle (2.5885,11.467);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.467) rectangle (1.75,12.365);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.365) rectangle (4.9641,12.563);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.563) rectangle (1.75,13.11);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8406) rectangle (8.5558,7.7388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.7388) rectangle (5.6333,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.365) rectangle (5.8703,12.911);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.911) rectangle (5.6333,13.11);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.11) rectangle (6.1072,13.572);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.038) rectangle (6.1072,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8406) rectangle (11.333,7.7388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.7388) rectangle (11.333,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.365) rectangle (11.333,12.911);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.911) rectangle (11.333,13.11);
...
\node[black, centered, rotate=90] at (13.72, 9.6027) {Settles};
