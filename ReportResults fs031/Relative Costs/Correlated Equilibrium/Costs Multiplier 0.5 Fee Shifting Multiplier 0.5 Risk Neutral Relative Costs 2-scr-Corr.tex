...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1224) rectangle (4.5245,4.5457);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.5457) rectangle (3.4676,4.7473);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.7473) rectangle (2.4106,8.7138);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.7138) rectangle (1.75,11.432);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.966) rectangle (2.1464,14.014);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1224) rectangle (8.3583,4.7576);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.7576) rectangle (7.2404,4.924);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.924) rectangle (6.1224,6.8407);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8407) rectangle (5.6333,11.432);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.432) rectangle (5.8429,12.48);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1224) rectangle (11.333,6.8407);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.8407) rectangle (11.333,11.432);
...
\node[black, centered, rotate=90] at (13.72, 7.7773) {Settles};
