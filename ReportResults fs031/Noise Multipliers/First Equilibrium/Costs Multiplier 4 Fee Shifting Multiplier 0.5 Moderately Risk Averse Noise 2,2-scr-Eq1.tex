...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.0476,3.6941);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.6941) rectangle (1.75,7.3864);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.3864) rectangle (2.5286,10.764);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.764) rectangle (1.75,12.141);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.141) rectangle (3.372,13.082);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.082) rectangle (1.75,14.229);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.229) rectangle (3.8262,14.295);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.295) rectangle (1.75,14.421);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.421) rectangle (2.5286,14.466);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.497) rectangle (2.5286,14.499);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.3864) rectangle (6.931,8.764);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.764) rectangle (5.6333,12.141);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.141) rectangle (6.8661,13.289);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.289) rectangle (5.6333,14.229);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.229) rectangle (6.4119,14.356);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.356) rectangle (5.6333,14.421);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.421) rectangle (7.7095,14.449);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.449) rectangle (6.4119,14.494);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.494) rectangle (6.4119,14.496);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.3864) rectangle (10.425,8.764);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.764) rectangle (10.425,12.141);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.141) rectangle (11.333,13.289);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.289) rectangle (11.333,14.229);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.229) rectangle (11.333,14.356);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.356) rectangle (11.333,14.421);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.421) rectangle (11.333,14.449);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.449) rectangle (11.333,14.494);
...
\node[black, centered, rotate=90] at (13.72, 9.7638) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 13.185) {Settles};
