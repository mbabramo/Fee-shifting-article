...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.1931,2.8733);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.8733) rectangle (3.692,4.8242);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.8242) rectangle (3.1908,6.1409);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.1409) rectangle (1.75,11.046);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.046) rectangle (4.4437,11.413);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.413) rectangle (1.75,12.271);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.271) rectangle (1.9379,13.631);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.0741,1.9153);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9153) rectangle (6.573,2.2355);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2355) rectangle (6.0718,6.6554);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.6554) rectangle (5.6333,11.046);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.046) rectangle (5.8213,11.904);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.904) rectangle (5.6333,12.271);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.271) rectangle (8.327,12.418);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.418) rectangle (5.8213,13.778);
