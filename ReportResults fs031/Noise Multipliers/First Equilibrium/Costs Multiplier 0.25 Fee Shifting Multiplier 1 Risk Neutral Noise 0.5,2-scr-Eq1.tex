...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.712,2.3198);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3198) rectangle (3.4482,2.3828);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3828) rectangle (2.1844,3.937);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.937) rectangle (1.75,8.8673);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.5953,2.0531);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0531) rectangle (7.3315,2.3618);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3618) rectangle (6.0678,6.6803);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.6803) rectangle (5.6333,8.8673);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (11.333,6.0685);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.0685) rectangle (11.333,6.6383);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.6383) rectangle (11.333,7.2501);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.2501) rectangle (11.333,8.8673);
