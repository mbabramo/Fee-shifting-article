...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.4015,3.1996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.1996) rectangle (1.75,8.8685);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.8685) rectangle (2.7409,13.693);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.693) rectangle (1.75,14.308);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.308) rectangle (4.2273,14.361);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.361) rectangle (1.75,14.419);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.419) rectangle (4.3924,14.434);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.434) rectangle (1.75,14.451);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.451) rectangle (2.7409,14.46);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.473) rectangle (3.7318,14.493);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.8685) rectangle (7.2848,9.4839);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4839) rectangle (5.6333,14.308);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.308) rectangle (6.7894,14.366);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.366) rectangle (5.6333,14.419);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.419) rectangle (6.6242,14.436);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.456) rectangle (6.6242,14.465);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.465) rectangle (7.6152,14.469);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.469) rectangle (5.9636,14.473);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.8685) rectangle (10.425,9.4839);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4839) rectangle (10.425,14.308);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.308) rectangle (11.333,14.366);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.366) rectangle (11.333,14.419);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.419) rectangle (11.333,14.436);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.436) rectangle (11.333,14.451);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.451) rectangle (11.333,14.456);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.456) rectangle (11.333,14.465);
...
\node[black, centered, rotate=90] at (13.72, 5.3092) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 11.588) {D Doesn't Answer};
