...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5119) rectangle (2.0906,8.7326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.7326) rectangle (1.75,9.1605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (3.1125,10.236);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.236) rectangle (1.75,11.105);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.105) rectangle (4.3615,11.567);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.567) rectangle (1.75,13.058);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.058) rectangle (2.0906,14.049);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (7.2229,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.03) rectangle (5.6333,11.105);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.105) rectangle (5.974,12.597);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.597) rectangle (5.6333,13.058);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.058) rectangle (8.2448,13.266);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.266) rectangle (5.974,14.256);
