...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4097) rectangle (2.5286,13.313);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.313) rectangle (1.75,13.889);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.889) rectangle (3.372,14.172);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.172) rectangle (1.75,14.375);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.375) rectangle (3.8262,14.412);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4097) rectangle (6.931,9.9855);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.9855) rectangle (5.6333,13.889);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.889) rectangle (6.8661,14.093);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.093) rectangle (5.6333,14.375);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.375) rectangle (6.4119,14.447);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4097) rectangle (10.425,9.9855);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.9855) rectangle (10.425,13.889);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.889) rectangle (11.333,14.093);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.093) rectangle (11.333,14.375);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.375) rectangle (11.333,14.447);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.447) rectangle (11.333,14.484);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.484) rectangle (11.333,14.487);
...
\node[black, centered, rotate=90] at (13.72, 11.649) {D Doesn't Answer};
