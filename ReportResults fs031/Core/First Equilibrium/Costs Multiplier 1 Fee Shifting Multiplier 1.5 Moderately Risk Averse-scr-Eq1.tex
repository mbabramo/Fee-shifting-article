...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5119) rectangle (2.0614,8.7326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.7326) rectangle (1.75,9.1605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (2.9957,10.236);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.236) rectangle (1.75,11.105);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.105) rectangle (4.1376,11.567);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.567) rectangle (1.75,13.058);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.058) rectangle (2.0614,14.049);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.049) rectangle (1.75,14.256);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5119) rectangle (7.7095,5.9398);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.9398) rectangle (5.6333,9.1605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (7.0867,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.03) rectangle (5.6333,11.105);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.105) rectangle (5.9448,12.597);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.597) rectangle (5.6333,13.058);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.058) rectangle (8.021,13.266);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.266) rectangle (5.9448,14.256);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.4) rectangle (7.1905,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (11.333,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.03) rectangle (11.333,11.105);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.105) rectangle (11.333,12.597);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.597) rectangle (11.333,13.058);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.058) rectangle (11.333,13.266);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.266) rectangle (11.333,14.256);
...
\node[black, centered, rotate=90] at (13.72, 10.133) {Settles};
