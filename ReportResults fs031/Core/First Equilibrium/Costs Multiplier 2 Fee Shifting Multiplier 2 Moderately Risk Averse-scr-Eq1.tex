...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.0476,2.1145);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.1145) rectangle (1.75,4.8413);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.8413) rectangle (2.1393,8.0803);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0803) rectangle (1.75,8.5229);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.5229) rectangle (2.853,10.509);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.509) rectangle (1.75,12.931);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.931) rectangle (3.4369,13.031);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.031) rectangle (1.75,13.677);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.677) rectangle (2.1393,14.357);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.8413) rectangle (6.931,5.2839);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.2839) rectangle (5.6333,8.5229);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.5229) rectangle (6.6065,10.945);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.945) rectangle (5.6333,12.931);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.931) rectangle (6.0226,13.578);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.578) rectangle (5.6333,13.677);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.677) rectangle (7.3202,13.809);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.809) rectangle (6.0226,14.489);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.8413) rectangle (10.425,5.2839);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.2839) rectangle (10.425,8.5229);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.5229) rectangle (11.333,10.945);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.945) rectangle (11.333,12.931);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.931) rectangle (11.333,13.578);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.578) rectangle (11.333,13.677);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.677) rectangle (11.333,13.809);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.809) rectangle (11.333,14.489);
...
\node[black, centered, rotate=90] at (13.72, 3.2957) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 6.6821) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 10.727) {Settles};
