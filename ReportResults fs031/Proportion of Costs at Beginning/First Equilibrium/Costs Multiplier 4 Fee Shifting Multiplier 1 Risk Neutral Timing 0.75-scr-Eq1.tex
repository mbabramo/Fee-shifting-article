...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.1251) rectangle (2.7118,13.064);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.064) rectangle (1.75,14.339);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.339) rectangle (3.727,14.376);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.376) rectangle (1.75,14.493);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.1251) rectangle (6.702,9.4);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4) rectangle (5.6333,14.339);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.339) rectangle (6.6485,14.455);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.455) rectangle (5.6333,14.493);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.498) rectangle (8.198,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.1251) rectangle (10.879,9.4);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4) rectangle (10.879,14.339);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.339) rectangle (12.242,14.455);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.455) rectangle (12.242,14.493);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.493) rectangle (13.15,14.495);
...
\node[black, centered, rotate=90] at (13.72, 11.232) {D Doesn't Answer};
