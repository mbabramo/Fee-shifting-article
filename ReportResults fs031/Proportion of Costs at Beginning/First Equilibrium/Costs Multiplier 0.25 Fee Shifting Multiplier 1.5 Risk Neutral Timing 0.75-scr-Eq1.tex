...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.8096,1.839);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.839) rectangle (1.75,2.8498);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.8498) rectangle (1.9221,5.0073);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.0073) rectangle (1.75,5.2456);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.2456) rectangle (4.8288,5.3911);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.8498) rectangle (8.693,3.0881);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.0881) rectangle (5.6333,5.2456);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.2456) rectangle (5.9584,6.3887);
