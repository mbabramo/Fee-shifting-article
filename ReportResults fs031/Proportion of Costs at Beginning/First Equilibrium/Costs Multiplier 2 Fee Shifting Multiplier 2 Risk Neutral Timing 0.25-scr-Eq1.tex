...
\draw[black, very thin] (13.35,8.5599) -- (13.45,8.5599);
\node[anchor=west] at (13.35, 8.5599) {};
\draw[black, very thin] (13.35,11.291) -- (13.45,11.291);
\node[anchor=west] at (13.35, 11.291) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.4775) rectangle (2.5935,7.5187);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.5187) rectangle (1.75,8.5599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.5599) rectangle (3.2423,9.0618);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.0618) rectangle (1.75,11.291);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.291) rectangle (1.9446,13.52);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.52) rectangle (1.75,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.4775) rectangle (6.4768,7.5187);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.5187) rectangle (5.6333,8.5599);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.5599) rectangle (5.828,10.789);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.789) rectangle (5.6333,11.291);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.291) rectangle (7.1256,11.793);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.793) rectangle (5.828,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.4775) rectangle (10.425,7.5187);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.5187) rectangle (10.425,8.5599);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.5599) rectangle (10.425,10.789);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.789) rectangle (10.425,11.291);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.291) rectangle (10.425,11.793);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.793) rectangle (10.425,14.022);
...
\draw[black, dotted] (1.5,8.5599) -- (13.4,8.5599);
\draw[black, dotted] (1.5,11.291) -- (13.4,11.291);
...
\node[black, centered, rotate=90] at (13.72, 7.5187) {Settles};
\node[black, centered, rotate=90] at (13.72, 9.9253) {P Abandons};
\node[black, centered, rotate=90] at (13.72, 12.656) {D Defaults};
