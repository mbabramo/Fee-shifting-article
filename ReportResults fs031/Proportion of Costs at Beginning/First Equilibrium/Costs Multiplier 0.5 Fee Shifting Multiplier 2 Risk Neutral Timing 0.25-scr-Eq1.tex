...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.2244,2.1779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1779) rectangle (3.0968,2.2345);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2345) rectangle (1.9693,5.4552);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.4552) rectangle (1.75,9.1605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (4.3497,9.4204);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.4204) rectangle (1.75,10.308);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.308) rectangle (1.844,11.196);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.196) rectangle (1.75,11.456);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (8.1078,2.1779);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.1779) rectangle (6.9802,2.2345);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2345) rectangle (5.8526,5.4553);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.4553) rectangle (5.6333,9.1605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (5.7273,10.048);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.048) rectangle (5.6333,10.308);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.308) rectangle (8.233,10.568);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.568) rectangle (5.7273,11.456);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.425,10.048);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.048) rectangle (10.425,10.308);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.308) rectangle (10.425,10.568);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.568) rectangle (10.425,11.456);
