...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (4.5449,2.1892);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.1892) rectangle (1.75,5.2586);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.2586) rectangle (2.0644,8.4862);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.4862) rectangle (1.75,8.9196);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.9196) rectangle (4.7196,9.3265);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.3265) rectangle (3.4619,9.6072);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.6072) rectangle (2.2042,10.921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.921) rectangle (1.75,13.094);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.094) rectangle (2.0644,13.105);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.2586) rectangle (8.4282,5.692);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.692) rectangle (5.6333,8.9196);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.9196) rectangle (8.6029,9.2923);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.2923) rectangle (7.3452,9.5824);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.5824) rectangle (6.0875,11.093);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.093) rectangle (5.808,12.407);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.407) rectangle (5.6333,13.094);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.094) rectangle (8.7426,13.098);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.098) rectangle (5.9478,13.11);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.2586) rectangle (10.879,5.692);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.692) rectangle (10.879,8.9196);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.9196) rectangle (12.242,9.2923);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.2923) rectangle (12.242,10.606);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.606) rectangle (12.242,10.896);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.896) rectangle (12.242,11.177);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.177) rectangle (12.242,12.687);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.687) rectangle (12.242,13.094);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.094) rectangle (12.242,13.098);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.098) rectangle (12.242,13.11);
...
\node[black, centered, rotate=90] at (13.72, 3.5043) {P Doesn't File};
\node[black, centered, rotate=90] at (13.72, 7.0891) {D Doesn't Answer};
\node[black, centered, rotate=90] at (13.72, 11.007) {Settles};
