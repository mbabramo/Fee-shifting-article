...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5119) rectangle (2.1393,8.1674);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.1674) rectangle (1.75,8.4882);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.4882) rectangle (2.7232,11.022);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.022) rectangle (1.75,13.031);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.031) rectangle (3.4369,13.163);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.163) rectangle (1.75,13.845);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.845) rectangle (2.1393,14.409);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.495) rectangle (2.5286,14.498);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5119) rectangle (6.931,5.8327);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.8327) rectangle (5.6333,8.4882);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.4882) rectangle (6.7363,10.497);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.497) rectangle (5.6333,13.031);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.031) rectangle (6.0226,13.712);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.712) rectangle (5.6333,13.845);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.845) rectangle (7.3202,13.927);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.927) rectangle (6.0226,14.491);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.491) rectangle (6.4119,14.494);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5119) rectangle (9.9708,5.8327);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.8327) rectangle (9.9708,8.4882);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.4882) rectangle (10.425,10.497);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.497) rectangle (10.425,13.031);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.031) rectangle (10.425,13.712);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.712) rectangle (10.425,13.845);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.845) rectangle (10.425,13.927);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.927) rectangle (10.425,14.491);
...
\node[black, centered, rotate=90] at (13.72, 7) {No Answer};
