...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.6145,2.1388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1388) rectangle (3.232,2.6245);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.6245) rectangle (2.8496,5.5894);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.5894) rectangle (1.75,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.81) rectangle (3.8057,11.223);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.223) rectangle (1.75,12.128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.128) rectangle (1.8934,14.178);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (6.7329,2.7651);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.7651) rectangle (6.3504,3.7072);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.7072) rectangle (5.968,6.9711);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9711) rectangle (5.6333,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.81) rectangle (5.7768,11.715);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.715) rectangle (5.6333,12.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.128) rectangle (7.689,12.34);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.34) rectangle (5.7768,14.389);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (10.425,2.6921);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.6921) rectangle (10.425,3.1778);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.1778) rectangle (10.425,7.4568);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.4568) rectangle (10.425,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.81) rectangle (10.425,11.715);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.715) rectangle (10.425,12.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.128) rectangle (10.425,12.34);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.34) rectangle (10.425,14.389);
