...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5119) rectangle (2.1803,9.6455);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.6455) rectangle (1.75,10.359);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.359) rectangle (3.232,11.228);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.228) rectangle (1.75,12.303);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.303) rectangle (4.0925,12.556);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.556) rectangle (1.75,13.632);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.632) rectangle (2.1803,14.211);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.211) rectangle (1.75,14.387);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.359) rectangle (6.9241,11.434);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.434) rectangle (5.6333,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.303) rectangle (6.0636,13.38);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.38) rectangle (5.6333,13.632);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.632) rectangle (7.9759,13.808);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.808) rectangle (6.0636,14.387);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5119) rectangle (10.879,6.2249);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.2249) rectangle (10.879,10.359);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.359) rectangle (12.242,11.434);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.434) rectangle (12.242,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.303) rectangle (12.242,13.38);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.38) rectangle (12.242,13.632);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.632) rectangle (12.242,13.808);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.808) rectangle (12.242,14.387);
...
\node[black, centered, rotate=90] at (13.72, 11.331) {Settles};
