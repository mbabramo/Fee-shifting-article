...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.806) rectangle (2.4767,12.207);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.207) rectangle (1.75,12.527);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.527) rectangle (2.9308,12.867);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.867) rectangle (1.75,13.678);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.678) rectangle (2.0225,14.076);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.076) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.806) rectangle (6.36,12.126);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.126) rectangle (5.6333,12.527);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.527) rectangle (5.9058,13.339);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.339) rectangle (5.6333,13.678);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.678) rectangle (6.8142,13.807);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.807) rectangle (5.9058,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.806) rectangle (10.425,12.126);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.126) rectangle (10.425,12.527);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.527) rectangle (10.425,13.339);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.339) rectangle (10.425,13.678);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.678) rectangle (10.425,13.807);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.807) rectangle (10.425,14.204);
