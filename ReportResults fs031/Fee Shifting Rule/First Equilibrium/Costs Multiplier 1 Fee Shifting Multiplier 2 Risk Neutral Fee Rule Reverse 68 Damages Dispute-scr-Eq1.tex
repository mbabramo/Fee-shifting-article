...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.2671) rectangle (2.6105,8.2673);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.2673) rectangle (2.5149,8.3313);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.3313) rectangle (2.4193,8.3954);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.3954) rectangle (2.3237,8.3955);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.3955) rectangle (2.3237,8.4124);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.4124) rectangle (2.2281,8.7191);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.7191) rectangle (2.1325,8.7382);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.7382) rectangle (2.1325,8.8408);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.8408) rectangle (2.0368,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.03) rectangle (1.9412,11.312);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.312) rectangle (1.8456,11.316);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.316) rectangle (1.8456,11.764);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.695) rectangle (4.9053,12.695);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.695) rectangle (4.4272,12.716);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.716) rectangle (3.9491,13.066);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.066) rectangle (3.4711,13.547);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.547) rectangle (2.993,13.547);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.547) rectangle (2.6105,13.547);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.547) rectangle (2.5149,13.547);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.547) rectangle (2.1325,13.547);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2665) rectangle (6.6851,8.2716);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2716) rectangle (6.5895,8.2718);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.2718) rectangle (6.4939,8.2718);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2718) rectangle (6.4939,8.4571);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.4571) rectangle (6.3982,8.5204);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.5204) rectangle (6.3026,8.5204);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.5204) rectangle (6.3026,8.8218);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.8218) rectangle (6.207,9.1972);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1972) rectangle (6.1114,9.1972);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.1972) rectangle (6.1114,9.6496);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6496) rectangle (6.0158,10.931);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.931) rectangle (5.9202,12.12);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.12) rectangle (5.8246,12.242);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.242) rectangle (5.7289,12.549);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.695) rectangle (8.7886,12.695);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.695) rectangle (8.7886,12.695);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.695) rectangle (8.3105,12.695);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.695) rectangle (8.3105,12.73);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.73) rectangle (7.8325,12.73);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.73) rectangle (7.8325,13.171);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.171) rectangle (7.3544,13.645);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.645) rectangle (6.8763,13.647);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.647) rectangle (6.3982,13.647);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.647) rectangle (6.0158,13.647);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.647) rectangle (6.0158,13.647);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.647) rectangle (5.9202,13.647);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2665) rectangle (11.333,10.314);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.314) rectangle (11.333,10.314);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.314) rectangle (11.333,10.779);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.779) rectangle (11.333,10.779);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.779) rectangle (11.333,12.695);
...
\node[black, centered, rotate=90] at (13.72, 10.481) {Settles};
