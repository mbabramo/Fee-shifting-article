...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5119) rectangle (2.2455,10.33);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.33) rectangle (1.75,11.407);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.407) rectangle (3.8144,11.778);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.778) rectangle (1.75,13.085);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.085) rectangle (3.897,13.091);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.091) rectangle (1.75,13.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.108) rectangle (2.2455,13.251);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.251) rectangle (1.75,13.335);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.335) rectangle (5.3833,13.365);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.365) rectangle (4.3924,13.53);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.53) rectangle (1.75,13.947);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.947) rectangle (2.7409,14.201);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5119) rectangle (7.2848,6.589);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.589) rectangle (5.6333,11.407);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.407) rectangle (6.2114,12.714);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.714) rectangle (5.6333,13.085);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.085) rectangle (6.1288,13.102);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.102) rectangle (5.6333,13.108);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.108) rectangle (7.7803,13.192);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.192) rectangle (6.1288,13.335);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.335) rectangle (6.6242,13.624);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.947) rectangle (9.2667,13.975);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.975) rectangle (8.2758,14.143);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.143) rectangle (7.6152,14.246);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.246) rectangle (6.6242,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.407) rectangle (11.333,12.714);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.714) rectangle (11.333,13.085);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.085) rectangle (11.333,13.102);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.102) rectangle (11.333,13.108);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.108) rectangle (11.333,13.192);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.192) rectangle (11.333,13.335);
